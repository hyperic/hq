...
public class AgentClient {
    ...
    private AgentClient(AgentConfig config, SecureAgentConnection conn) {
        ...
        //log.info("provider address=" + camCommands.getProviderInfo().getProviderAddress() + " token=" + camCommands.getProviderInfo().getAgentToken());
        if (agentApplicationContext == null) {
            agentApplicationContext = new AgentApplicationContext(SpringAgentConfiguration.class);
            AbstractApplicationContext ctx = agentApplicationContext.getApplicationContext();
            for (Object o : ctx.getBeanDefinitionNames()) {
                System.out.println(o);
            }
            BizappCallbackClient bcc = agentApplicationContext.getBean(BizappCallbackClient.class);
