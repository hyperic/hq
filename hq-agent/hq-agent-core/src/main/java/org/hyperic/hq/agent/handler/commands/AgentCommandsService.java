...
public class AgentCommandsService implements AgentCommandsClient {
    ...
    public AgentCommandsService(AgentService agentService) throws AgentRunningException {
        this.agentService = agentService;
        _agentTransportLifecycle = agentService.getAgentTransportLifecycle();
    }
...
//          Safe to truncate to int here, since buf.length is an int
    ...
    public String getCurrentAgentBundle() throws AgentRemoteException {
        return agentService.getCurrentAgentBundle();
    }
    ...
    /**
     * @see org.hyperic.hq.agent.client.AgentCommandsClient#upgrade(String, String)
     */
