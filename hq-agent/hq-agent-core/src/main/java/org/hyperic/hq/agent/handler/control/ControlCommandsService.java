...
public class ControlCommandsService implements ControlCommandsClient {
    ...
    /**
     * @see org.hyperic.hq.control.agent.client.ControlCommandsClient#controlPluginAdd(String, String, org.hyperic.util.config.ConfigResponse)
     */
    ...
    /**
     * @see org.hyperic.hq.control.agent.client.ControlCommandsClient#controlPluginCommand(String, String, Integer, String, String)
     */
    ...
    /**
     * @see org.hyperic.hq.control.agent.client.ControlCommandsClient#controlPluginRemove(String)
     */
