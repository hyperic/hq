...
public class AgentDListProvider
    ...
    private Log log = LogFactory.getLog(AgentDListProvider.class);
    private final Map<String, String> keyVals = new HashMap<String, String>();
    private final Map<String, DiskList> lists = new HashMap<String, DiskList>();
    private Map<String, ListInfo> overloads;
    ...
    public synchronized void flush()
        ...
        try {
            ...
            synchronized (this.keyVals) {
                ...
                for (Map.Entry<String, String> ent : this.keyVals.entrySet()) {
    ...
    public void dispose() {
        ...
        for (Map.Entry<String, DiskList> ent : this.lists.entrySet()) {
            DiskList dl = ent.getValue();

            try {
                if (!dl.isClosed()) dl.close();
            } catch (Exception exc) {
