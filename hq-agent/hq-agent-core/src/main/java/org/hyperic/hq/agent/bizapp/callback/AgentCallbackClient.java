...
public abstract class AgentCallbackClient {
    ...
    private static final Log log = LogFactory.getLog(AgentCallbackClient.class.getName());
    ...
    public AgentCallbackClient() {
        setSecureCommands(CommandInfo.SECURE_COMMANDS);
    }
    ...
    public AgentCallbackClient(ProviderFetcher fetcher, String[] secureCommands) {
        setFetcher(fetcher);
        setSecureCommands(secureCommands);
    }


    public void setFetcher(ProviderFetcher fetcher) {
        this.fetcher = fetcher;
    }

    public void setSecureCommands(String[] commands) {
        Collections.addAll(this.secureCommands, commands);
    }
