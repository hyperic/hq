...
public class AICommandsService implements AICommandsClient {
    ...
    /**
     * @see org.hyperic.hq.autoinventory.agent.client.AICommandsClient#pushRuntimeDiscoveryConfig(int, int, String, String, org.hyperic.util.config.ConfigResponse)
     */
