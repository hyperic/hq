...
public class MeasurementCommandsService implements MeasurementCommandsClient {
    ...
    /**
     * @see org.hyperic.hq.measurement.agent.client.MeasurementCommandsClient#addTrackPlugin(String, String, String, org.hyperic.util.config.ConfigResponse)
     */
    ...
    /**
     * @see org.hyperic.hq.measurement.agent.client.MeasurementCommandsClient#removeTrackPlugin(String, String)
     */
