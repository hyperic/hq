...
class RtScheduleThread implements Runnable {
    ...
    private          Hashtable  serverIDs;   // Hash of server IDs->schedule IDs
    ...
    private AgentStorageProvider storage;       // Place to store data
    private RtPluginManager      manager;
    private Log                  log;
    private RtSenderThread       sender;        // Guy handling the results

    RtScheduleThread(RtSenderThread sender, RtPluginManager manager,
