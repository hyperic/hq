...
/**
 * Hibernate custom {@link String} user type responsible for the serialization&encoding of 
 * objects into Base64 representation during an update/insert operation and the<br>
...
public class EncodedSerializedStringUserType<T> implements UserType{
	...
	public EncodedSerializedStringUserType(){}//EOM 
	...
	/**
	 * Extracts the String from the resultset using the names[0] value, Decodes from Base64
	 * and finally deserializes. 
	...
	public final Object nullSafeGet(final ResultSet rs, final String[] names, final Object owner)
		...
		//retrieve the string from the resultset and if not null decode and deserialize 
	...
	public final void nullSafeSet(final PreparedStatement st, final Object value, final int index)
		...
		try{ 
			...
			final String sEncodedValue = ObjectCoder.encode(null/*alias*/, value) ; 
