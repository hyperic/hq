...
INSERT INTO EAM_SUBJECT (DSN,EMAIL_ADDRESS,FACTIVE,FIRST_NAME,FSYSTEM,HTML_EMAIL,ID,LAST_NAME,NAME,PREFS) VALUES ('CAM','${server.admin.email}',0,'Guest',0,0,'2','User','guest','3')
