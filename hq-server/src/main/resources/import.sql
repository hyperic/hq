...
CREATE TABLE EAM_MEASUREMENT_DATA_1D (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,MINVALUE decimal(24,5) DEFAULT NULL,MAXVALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
...
CREATE TABLE EAM_MEASUREMENT_DATA_1H (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,MINVALUE decimal(24,5) DEFAULT NULL,MAXVALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
...
CREATE TABLE EAM_MEASUREMENT_DATA_6H (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,MINVALUE decimal(24,5) DEFAULT NULL,MAXVALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
...
CREATE TABLE HQ_METRIC_DATA_0D_0S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_0D_0S_MID_IDX ON HQ_METRIC_DATA_0D_0S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_0D_1S;
CREATE TABLE HQ_METRIC_DATA_0D_1S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_0D_1S_MID_IDX ON HQ_METRIC_DATA_0D_1S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_1D_0S;
CREATE TABLE HQ_METRIC_DATA_1D_0S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_1D_0S_MID_IDX ON HQ_METRIC_DATA_1D_0S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_1D_1S;
CREATE TABLE HQ_METRIC_DATA_1D_1S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_1D_1S_MID_IDX ON HQ_METRIC_DATA_1D_1S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_2D_0S;
CREATE TABLE HQ_METRIC_DATA_2D_0S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_2D_0S_MID_IDX ON HQ_METRIC_DATA_2D_0S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_2D_1S;
CREATE TABLE HQ_METRIC_DATA_2D_1S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_2D_1S_MID_IDX ON HQ_METRIC_DATA_2D_1S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_3D_0S;
CREATE TABLE HQ_METRIC_DATA_3D_0S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_3D_0S_MID_IDX ON HQ_METRIC_DATA_3D_0S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_3D_1S;
CREATE TABLE HQ_METRIC_DATA_3D_1S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_3D_1S_MID_IDX ON HQ_METRIC_DATA_3D_1S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_4D_0S;
CREATE TABLE HQ_METRIC_DATA_4D_0S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_4D_0S_MID_IDX ON HQ_METRIC_DATA_4D_0S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_4D_1S;
CREATE TABLE HQ_METRIC_DATA_4D_1S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_4D_1S_MID_IDX ON HQ_METRIC_DATA_4D_1S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_5D_0S;
CREATE TABLE HQ_METRIC_DATA_5D_0S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_5D_0S_MID_IDX ON HQ_METRIC_DATA_5D_0S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_5D_1S;
CREATE TABLE HQ_METRIC_DATA_5D_1S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_5D_1S_MID_IDX ON HQ_METRIC_DATA_5D_1S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_6D_0S;
CREATE TABLE HQ_METRIC_DATA_6D_0S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_6D_0S_MID_IDX ON HQ_METRIC_DATA_6D_0S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_6D_1S;
CREATE TABLE HQ_METRIC_DATA_6D_1S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_6D_1S_MID_IDX ON HQ_METRIC_DATA_6D_1S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_7D_0S;
CREATE TABLE HQ_METRIC_DATA_7D_0S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_7D_0S_MID_IDX ON HQ_METRIC_DATA_7D_0S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_7D_1S;
CREATE TABLE HQ_METRIC_DATA_7D_1S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_7D_1S_MID_IDX ON HQ_METRIC_DATA_7D_1S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_8D_0S;
CREATE TABLE HQ_METRIC_DATA_8D_0S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_8D_0S_MID_IDX ON HQ_METRIC_DATA_8D_0S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_8D_1S;
CREATE TABLE HQ_METRIC_DATA_8D_1S (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CReATE INDEX METRIC_DATA_8D_1S_MID_IDX ON HQ_METRIC_DATA_8D_1S(MEASUREMENT_ID);
DROP TABLE IF EXISTS HQ_METRIC_DATA_compat;
CREATE TABLE HQ_METRIC_DATA_compat (TIMESTAMP bigint NOT NULL,MEASUREMENT_ID int NOT NULL,VALUE decimal(24,5) DEFAULT NULL,PRIMARY KEY (TIMESTAMP,MEASUREMENT_ID));
CREATE INDEX METRIC_DATA_COMPAT_MID_IDX ON HQ_METRIC_DATA_compat(MEASUREMENT_ID);
