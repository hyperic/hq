    ...
    implements java.io.Serializable
{
    ...
    private org.hyperic.hq.agent.mgmt.domain.Agent Agent;
    ...
    public org.hyperic.hq.agent.mgmt.domain.Agent getAgent()
    {
        return Agent;
    }
    public void setAgent( org.hyperic.hq.agent.mgmt.domain.Agent Agent )
    {
        this.Agent = Agent;
        AgentHasBeenSet = true;
    }
