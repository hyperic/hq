...
public class PlatformCreatedZEvent extends ResourceCreatedZevent {
	private String macAddress;
	private String ipAddress;
	
	public PlatformCreatedZEvent(AuthzSubject subject, AppdefEntityID aeid, Collection<Ip> ips) {
		super(subject, aeid);
