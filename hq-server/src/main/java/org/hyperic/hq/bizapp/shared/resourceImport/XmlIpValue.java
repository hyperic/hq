...
public class XmlIpValue
    extends XmlValue
{
    private static final String ATTR_ADDRESS     = "address";
    private static final String ATTR_NETMASK     = "netmask";
    private static final String ATTR_MACADDRESS  = "macaddress";
    ...
    public String getNetmask(){
        return this.getValue(ATTR_NETMASK);
    }

    public String getMacAddress(){
        return this.getValue(ATTR_MACADDRESS);
    }
