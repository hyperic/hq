...
public class Neo4jResourceGroup extends Neo4jResource implements ResourceGroup {
    @RelatedTo(type = RelationshipTypes.HAS_MEMBER, direction = Direction.OUTGOING, elementClass = Neo4jResource.class)
