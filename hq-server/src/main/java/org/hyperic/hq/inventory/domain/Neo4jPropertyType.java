...
public class Neo4jPropertyType implements PropertyType {
    @GraphProperty
    @Transient
    ...
    @ManyToOne
    @Transient
    @RelatedTo(type = RelationshipTypes.HAS_PROPERTY_TYPE, direction = Direction.INCOMING, elementClass = Neo4jResourceType.class)
    private Neo4jResourceType resourceType;
    ...
    public Neo4jResourceType getResourceType() {
    ...
    public void setResourceType(Neo4jResourceType resourceType) {
