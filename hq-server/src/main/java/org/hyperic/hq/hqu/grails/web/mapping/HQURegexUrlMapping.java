 ...
 *
 */
public class HQURegexUrlMapping extends AbstractUrlMapping implements UrlMapping {
     ...
     */
    public HQURegexUrlMapping(UrlMappingData data, Object controllerName, Object actionName, Object viewName, ConstrainedProperty[] constraints, ServletContext servletContext) {
     ...
     */
    public HQURegexUrlMapping(UrlMappingData data, URI uri, ConstrainedProperty[] constraints,
    ...
    private UrlMappingInfo createUrlMappingInfo(String uri, Matcher m) {
        ...
        DefaultHQUUrlMappingInfo info;
        if(forwardURI != null && this.controllerName == null) {
        	info = new DefaultHQUUrlMappingInfo(forwardURI, this.urlData, servletContext);
        }
        else if (viewName != null && this.controllerName == null) {
            info = new DefaultHQUUrlMappingInfo(viewName, params, this.urlData, servletContext);
        } else {
            info =  new DefaultHQUUrlMappingInfo(this.controllerName, this.actionName, getViewName(), params, this.urlData, servletContext);
        }
