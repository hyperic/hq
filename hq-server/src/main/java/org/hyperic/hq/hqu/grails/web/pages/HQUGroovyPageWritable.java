 ...
 *
 */
class HQUGroovyPageWritable implements Writable {
    private static final Log LOG = LogFactory.getLog(HQUGroovyPageWritable.class);
    ...
    public HQUGroovyPageWritable(HQUGroovyPageMetaInfo metaInfo) {
    ...
    private boolean shouldShowGroovySource(HQUGroovyPageMetaInfo metaInfo) {
     ...
     */
    protected void writeGroovySourceToResponse(HQUGroovyPageMetaInfo info, Writer out) throws IOException {
    ...
    private void formulateBindingFromWebRequest(Binding binding, HttpServletRequest request, HttpServletResponse response, Writer out, GroovyObject controller) {
        ...
        // TODO: for now just disable ctx lookup
//        if(appCtx!=null) {
