 ...
 *        Time: 5:45:32 PM
 */
public class DefaultHQUUrlMappingEvaluator implements UrlMappingEvaluator, ClassLoaderAware {
    ...
    public DefaultHQUUrlMappingEvaluator(ServletContext servletContext) {
    ...
    class UrlMappingBuilder extends GroovyObjectSupport {
            ...
            if (methodName.startsWith(SLASH) || isResponseCode) {
                ...
                try {
                    ...
                    if (args[0] instanceof Closure) {
                        ...
                        if(uri!=null) {
                        	try {
								urlMapping = new HQURegexUrlMapping(urlData, new URI(uri.toString()), constraints, servletContext);
        ...
        private UrlMapping createURLMapping(UrlMappingData urlData, boolean isResponseCode, Object controllerName, Object actionName, Object viewName, ConstrainedProperty[] constraints) {
            if (!isResponseCode) {
                return new HQURegexUrlMapping(urlData,
