 ...
 *
 */
public class HQUGroovyPageMetaInfo {
	private static final Log LOG=LogFactory.getLog(HQUGroovyPageMetaInfo.class);
    ...
    public HQUGroovyPageMetaInfo() {
    	
    }
    
    public HQUGroovyPageMetaInfo(Class pageClass) {
