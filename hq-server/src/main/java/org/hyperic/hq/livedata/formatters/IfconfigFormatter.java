...
import org.hyperic.hq.system.IfconfigData;
import org.hyperic.hq.system.NetInterfaceData;
    ...
    implements LiveDataFormatter
{
    ...
    private String formatHtml(ConfigResponse cfg, IfconfigData d) {
        ...
        r.append("<div class='ifconfig_livedata'><table cellpadding='0' cellspacing='0' width='100%'><thead><tr>");
        r.append("<td>")
