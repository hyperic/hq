...
@Component
public class DataPurgeJobImpl implements DataPurgeJob {
    ...
    private final Log log = LogFactory.getLog(DataPurgeJobImpl.class);

    @Autowired
    public DataPurgeJobImpl(ServerConfigManager serverConfigManager,
    ...
    public long compressData(long toInterval, long now) {
    ...
    public void purgeMeasurements(long dataInterval, long purgeAfter) {
    ...
    public void purgeMetricProblems(long purgeAfter) {
