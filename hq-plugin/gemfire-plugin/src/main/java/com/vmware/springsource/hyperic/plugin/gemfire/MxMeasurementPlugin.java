...
public class MxMeasurementPlugin extends MeasurementPlugin
{
    ...
    {
    //Would have been nice to salt this with some debug messages, but the friendly hyperic devs made log private :-(
    ...
    {
    //Would have been nice to salt this with some debug messages, but the friendly hyperic devs made log private :-(
    //log.debug("translate(String template, ConfigResponse config)");
