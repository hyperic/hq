...
public class AlertsListener implements NotificationListener {
    ...
    protected static Log log =
        LogFactory.getLog(AlertsListener.class.getName());

    private AlertsListener() { }
    
    public AlertsListener(LogTrackPlugin plugin) {
        this.plugin = plugin;
        this.props = plugin.getConfig().toProperties();
    }

    public static AlertsListener getInstance(AlertsPlugin plugin) {
        AlertsListener listener =
            new AlertsListener(plugin);
