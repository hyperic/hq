...
public class Tomcat60RuntimeADPlugin 
...
{                                                  
    ...
    private static final String WEBAPP_SERVICE_TYPENAME =
        ...
        ServletProductPlugin.TOMCAT_VERSION_60 + " " +
    ...
    private static Log log = LogFactory.getLog("Tomcat60RuntimeADPlugin");

    public Tomcat60RuntimeADPlugin () {}
