...
public class Tomcat50RuntimeADPlugin 
...
{                                                  
    ...
    private static final String WEBAPP_SERVICE_TYPENAME =
        ...
        ServletProductPlugin.TOMCAT_VERSION_50 + " " +
    ...
    private static Log log = LogFactory.getLog("Tomcat50RuntimeADPlugin");

    public Tomcat50RuntimeADPlugin () {}
