...
public class VMAndHostVCenterPlatformDetector implements VCenterPlatformDetector {
    ...
    protected void assertSuccess(Response response, String msg, boolean abort)
    ...
    protected Agent getAgent(HQApi hqApi, Properties props)
    ...
    protected void mergeVSphereConfig(VSphereResource platform, Properties props) {
        String[] vprops = {
    ...
    protected ResourcePrototype getResourceType(String name, HQApi hqApi)
        throws IOException, PluginException {
    ...
    protected boolean isVCenterManagedEntity(String vCenterUrl, Resource r) {
    ...
    protected String getFqdn(Resource r) {
        String fqdn = null;
     ...
     */
    protected String generatePlatformName(String name, String uuid) {
        return name + " {" + uuid + "}";
    }
