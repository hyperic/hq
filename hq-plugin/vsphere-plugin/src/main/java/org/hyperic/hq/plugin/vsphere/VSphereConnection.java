...
public class VSphereConnection {
    private static final Log _log =
        LogFactory.getLog(VSphereConnection.class.getName());
    ...
    static synchronized VSphereConnection getInstance(Properties props)
        ...
        VSphereConnection conn = (VSphereConnection)_connections.get(url);
        if (conn == null) {
            conn = new VSphereConnection();
        ...
        if (conn.vim == null) {
            conn.vim = VSphereUtil.getInstance(props);
