...
import org.hyperic.hq.plugin.rabbitmq.core.AmqpChannel;
...
/**
 * RabbitChannelCollector
 * @author Helena Edelson
 */
public class RabbitChannelCollector extends Collector {
     ...
     * @return
     */
    public static ConfigResponse getAttributes(AmqpChannel channel) {
