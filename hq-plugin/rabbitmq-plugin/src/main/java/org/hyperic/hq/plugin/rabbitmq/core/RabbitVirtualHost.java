...
public class RabbitVirtualHost {
    ...
    public static RabbitVirtualHost toRabbitVirtualHost(Configuration configuration) {
        RabbitVirtualHost vh = new RabbitVirtualHost();
        vh.setConnectionFactory();
    }
    ...
    public void setRabbitBrokerAdmin(RabbitBrokerAdmin rabbitBrokerAdmin) {
