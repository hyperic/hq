...
/**
 * RabbitContextCreator
 * @author Helena Edelson
 */
public class RabbitContextCreator {
     ...
     *
     */
    public static AbstractApplicationContext createContext(Configuration configuration) throws PluginException {
     ...
     *
     */
    protected static AbstractApplicationContext doCreateApplicationContext(AbstractApplicationContext context, Configuration conf) throws PluginException {
