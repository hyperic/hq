...
public class RabbitProductPlugin extends ProductPlugin {
    ...
    private static String erlangCookieLocation;

    private static final String ERLANG_PROP = "rabbitmq.erlangcookie";

    public void init(PluginManager manager) throws PluginException {
        super.init(manager);
        String cookie = manager.getProperty(ERLANG_PROP);
        if (cookie != null) {
            erlangCookieLocation = cookie;
        }
    }

    public static String getErlangCookieLocation() {
        return erlangCookieLocation;
    }
