...
/**
 * An exception which is thrown when a tag does not have a required
 * child tag.  This exception can be thrown when a tag is required
 * and is missing, or has a ONE_OR_MORE and is missing.
 */
