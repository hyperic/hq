...
public class JBossConfig {
    ...
    public static synchronized JBossConfig getConfig(File configXML) {
        ...
        JBossConfig cfg = (JBossConfig)cache.get(configXML);
    ...
    private void parse(InputStream is)
        ...
        JBossServiceHandler handler = new JBossServiceHandler();
        parser.parse(is, handler);

        this.jnpPort = handler.getJnpPort();
    }
    ...
    private class JBossServiceHandler extends DefaultHandler {
        ...
        private StringBuffer jnpPort = new StringBuffer();
        ...
        public void characters(char[] ch,
            ...
            if (inNamingPort) {
                jnpPort.append(ch, start, length);
                return;
            }
        }
        ...
        protected String getJnpPort() {
            return jnpPort.toString();
        }
    }
