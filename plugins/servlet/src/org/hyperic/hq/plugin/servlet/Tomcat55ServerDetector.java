...
public class Tomcat55ServerDetector 
    extends Tomcat41ServerDetector
    implements FileServerDetector,
               RegistryServerDetector {

    static final String UNIQUE_JAR = "catalina-storeconfig.jar";

    private Log log = LogFactory.getLog("Tomcat55ServerDetector");

    public Tomcat55ServerDetector () { 
        super();
