...
public class SNMPCollector extends Collector
{
   ...
   {
      String info = _props.getProperty ( SNMPClient.PROP_IP        ) + ":" +
   ...
   protected Map getIndexedColumn ( SNMPSession session,
                                    String      name ) throws SNMPException
   {
   ...
   protected Map getIndexedColumn ( SNMPSession session,
                                    String      name,
                                    boolean     asString ) throws SNMPException
   {
