/*
 * 'NetworkDevicePlatformDetector.java'
 *
 *
...
public class NetworkDevicePlatformDetector extends PlatformDetector
{
   ...
   private String getString ( SNMPSession session,
                              String      oid )
   {
      try
      {
   ...
   // 
   private String getIpProp ( String  key,
                              String  ip,
                              String  defVal )
   {
   ...
   public PlatformResource getPlatformResource ( ConfigResponse config ) throws PluginException
   {
      ...
      String defaultVersion = getIpProp ( SNMPClient.PROP_VERSION,
                                          platformIp,
