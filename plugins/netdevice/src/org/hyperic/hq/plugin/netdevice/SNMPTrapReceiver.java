...
public class SNMPTrapReceiver implements CommandResponder
{
   ...
   private static String getPluginKey ( String address,
                                        String community )
   {
   ...
   {
      String address = getConfig ( plugin,
                                   SNMPClient.PROP_IP,
                                   SNMPClient.DEFAULT_IP );

      String community = getConfig ( plugin,
   ...
   {
      String address = props.getProperty ( PROP_LISTEN_ADDRESS,
                                           DEFAULT_LISTEN_ADDRESS ).trim ( );

      String numThreads = props.getProperty ( "snmpTrapReceiver.numThreads",
                                              "1" );

      _threadPool = ThreadPool.create ( "SNMPTrapReceiver",
                                        Integer.parseInt ( numThreads ) );

      _dispatcher = new MultiThreadedMessageDispatcher ( _threadPool,
