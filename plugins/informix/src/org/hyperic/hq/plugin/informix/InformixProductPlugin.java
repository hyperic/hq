...
public class InformixProductPlugin extends ProductPlugin {

    static final String NAME = "informix";

    static final String SERVER_NAME = "Informix";
    static final String SERVER_DESC = "Database Server";
    static final String INSTANCE = "Instance";

    static final String VERSION = "10.x";

    static final String[] SERVICES = {
        INSTANCE
    };

    public InformixProductPlugin() {
        setName(NAME);
    }
    ...
    public GenericPlugin getPlugin(String type, TypeInfo entity)
    {
        if (type.equals(ProductPlugin.TYPE_MEASUREMENT)) {
            return new InformixMeasurementPlugin();
        }
    ...
    public TypeInfo[] getTypes() {
        ...
        server = types.addServer(VERSION);
