...
%define HQ_Component_Build	1285-noJRE
...
%setup -T -D -b 0 -n %{HQ_Component_Name}-%{HQ_Component_Version}-%{HQ_Component_Edition}
...
%{__rm} -rf background.bat hq-agent.exe rcfiles/ rpm.spec bundles/agent-%{HQ_Component_Version}-EE-`echo %{HQ_Component_Build} | cut -f1 -d-`/pdk/lib/sigar-x86-winnt.lib product_connectors/servlet-%{HQ_Component_Version}-EE/hyperic-hq/native-lib/sigar-x86-winnt.lib wrapper/sbin/wrapper-linux-ppc-64 wrapper/sbin/wrapper-hpux-parisc-64 wrapper/sbin/wrapper-solaris-sparc-32 wrapper/sbin/wrapper-solaris-sparc-64
