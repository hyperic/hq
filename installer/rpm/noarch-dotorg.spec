...
%{__rm} -rf background.bat hq-agent.exe rcfiles/ rpm.spec bundles/agent-%{HQ_Component_Version}-`echo %{HQ_Component_Build} | cut -f1 -d-`/pdk/lib/sigar-x86-winnt.lib product_connectors/servlet-%{HQ_Component_Version}/hyperic-hq/native-lib/sigar-x86-winnt.lib wrapper/sbin/wrapper-linux-ppc-64 wrapper/sbin/wrapper-hpux-parisc-64 wrapper/sbin/wrapper-solaris-sparc-32 wrapper/sbin/wrapper-solaris-sparc-64
