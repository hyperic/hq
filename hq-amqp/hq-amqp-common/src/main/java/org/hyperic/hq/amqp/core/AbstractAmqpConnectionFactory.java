 ...
 */
abstract class AbstractAmqpConnectionFactory extends ConnectionFactory {

    protected final Log logger = LogFactory.getLog(getClass());

    private final Map<List<Address>, Connection> connections = new HashMap<List<Address>, Connection>();
