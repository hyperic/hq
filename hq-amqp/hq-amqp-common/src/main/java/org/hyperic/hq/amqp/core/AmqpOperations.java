...
public interface AmqpOperations {
     ...
     * @param properties AMQP BasicProperties. Can be null.
      * @throws ChannelException
     */
    void send(String exchangeName, String routingKey, Object message, BasicProperties properties) throws ChannelException;
}
