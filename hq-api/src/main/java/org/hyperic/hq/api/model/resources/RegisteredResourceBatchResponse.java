...
public class RegisteredResourceBatchResponse extends ResourceBatchResponse {
    ...
    public RegisteredResourceBatchResponse(List<Resource> resourcesAddedToInventory,
    ...
    public RegisteredResourceBatchResponse(BatchResponse<Resource> batchResponse,
