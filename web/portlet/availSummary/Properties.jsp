...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr class="PageTitle">
    ...
    <td width="34%" class="PageTitle"><fmt:message key="dash.home.AvailSummary.Title"/></td>
    ...
    <td colspan='3'>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
         ...
         <tr valign="top">
          <td width="20%" class="BlockLabel" valign="center"><fmt:message key="dash.settings.FormLabel.AvailSummaryRange"/></td>
