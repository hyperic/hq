...
<html:form action="/resource/service/inventory/AddServiceGroups" method="POST">

<tiles:insert definition=".page.title.resource.service">
  <tiles:put name="titleKey" value="resource.service.inventory.AddToGroupsPageTitle"/>
...
<tiles:insert definition=".resource.common.inventory.addResourceGroups">
  ...
  <tiles:put name="resourceType" value="service"/> 
