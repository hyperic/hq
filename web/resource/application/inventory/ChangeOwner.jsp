...
<c:set var="selfUrl" value="/resource/application/Inventory.do?mode=changeOwner&rid=${Resource.id}&type=${Resource.entityId.type}"/>

<html:form action="/resource/application/inventory/ChangeOwner">
