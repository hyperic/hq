...
<html:form action="/resource/platform/inventory/AddPlatformGroups" method="POST">

<tiles:insert definition=".page.title.resource.platform">
  <tiles:put name="titleKey" value="resource.platform.inventory.AddToGroupsPageTitle"/>
