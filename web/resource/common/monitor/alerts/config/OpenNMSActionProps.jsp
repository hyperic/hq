...
<html:form action="/alerts/SetOpenNMSAction">
	...
	<logic:match name="OpenNMSForm" property="canModify" value="true">
		<table width="100%" cellpadding="5" cellspacing="0" border="0" class="ToolbarContent" style="border-bottom: 1px solid #D5D8DE;">
  			<tr>
  				<td align="center">
  					<html:image page="/images/tbb_set.gif" border="0" titleKey="FormButtons.ClickToOk" property="ok" style="padding-right: 5px;"/>
    				<html:image page="/images/tbb_remove.gif" border="0" titleKey="FormButtons.ClickToDelete" property="delete" style="padding-left: 5px;"/>
    			</td>
    		</tr>
		</table>
	</logic:match>
