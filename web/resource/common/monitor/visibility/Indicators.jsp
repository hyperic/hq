  ...
  <tr>
    ...
    <td class="ListHeaderInactive" valign="middle" align="right" width="100%">
      <table cellspacing="2">
        <tr>
          <td>
            <span style="padding-right:80px;"><a href='<html:rewrite page="/ResourceCurrentHealth.do"/>?eid=<c:out value="${eid}"/>&view=<c:out value="${view}"/>&alertDefaults=true'><fmt:message key="resource.common.monitor.visibility.now"/></a></span>
