...
<table width="685" cellpadding="2" cellspacing="0" border="0">
  <tr>
    <td class="ListHeaderInactive" nowrap="true" width="33%"><fmt:message key="resource.common.monitor.visibility.IndicatorCharts"/></td>
    <td class="ListHeaderInactive" valign="middle" align="center" width="33%">
    ...
    <td class="ListHeaderInactive" valign="middle" align="right" width="34%">
