...
public interface PlatformManager
{
    ...
    * @return List of PlatformTypeValues
    */
   public PageList<PlatformTypeValue> getViewablePlatformTypes( AuthzSubject subject,PageControl pc ) throws FinderException, PermissionException;
    ...
    */
   public void removePlatform( AuthzSubject subject,Platform platform ) throws RemoveException, PlatformNotFoundException, PermissionException, VetoException;
    ...
    */
   public Platform createPlatform( AuthzSubject subject,Integer platformTypeId,PlatformValue pValue,Integer agentPK ) throws CreateException, ValidationException, PermissionException, AppdefDuplicateNameException, AppdefDuplicateFQDNException, ApplicationException;

   /**
    * Create a Platform from an AIPlatform
    * @param aipValue the AIPlatform to create as a regular appdef platform.
    */
   public Platform createPlatform( AuthzSubject subject,AIPlatformValue aipValue ) throws ApplicationException, CreateException;
   ...
   public PageList<PlatformValue> getAllPlatforms( AuthzSubject subject,PageControl pc ) throws FinderException, PermissionException;
   ...
   public PageList<PlatformValue> getRecentPlatforms( AuthzSubject subject,long range,int size ) throws FinderException, PermissionException;

   /**
    * Get platform light value by id. Does not check permission.
    */
   public Platform getPlatformById( AuthzSubject subject,Integer id ) throws PlatformNotFoundException, PermissionException;
    ...
    */
   public Platform getPlatformByAIPlatform( AuthzSubject subject,AIPlatformValue aiPlatform ) throws PermissionException;
   ...
   public PlatformValue getPlatformByName( AuthzSubject subject,String name ) throws PlatformNotFoundException, PermissionException;
    ...
    */
   public Platform findPlatformByFqdn( AuthzSubject subject,String fqdn ) throws PlatformNotFoundException, PermissionException;
    ...
    */
   public Collection<Integer> getPlatformPksByAgentToken( AuthzSubject subject,String agentToken ) throws PlatformNotFoundException;
    ...
    * @return the Platform    */
   public PlatformValue getPlatformByService( AuthzSubject subject,Integer serviceId ) throws PlatformNotFoundException, PermissionException;
   ...
   public PlatformValue getPlatformByServer( AuthzSubject subject,Integer serverId ) throws PlatformNotFoundException, PermissionException;
    ...
    * @param subject The subject trying to list services.    */
   public PageList<PlatformValue> getPlatformsByServers(AuthzSubject subject, List<AppdefEntityID> sIDs) throws PlatformNotFoundException, PermissionException;
   ...
   public PageList<PlatformValue> getPlatformsByApplication( AuthzSubject subject,Integer appId,PageControl pc ) throws ApplicationNotFoundException, PlatformNotFoundException, PermissionException;
    ...
    * @return A PageList of ServerValue objects representing servers on the specified platform that the subject is allowed to view.    */
   public List<Platform> getPlatformsByType( AuthzSubject subject,String type ) throws PermissionException, InvalidAppdefTypeException;
    ...
    */
   public PageList<PlatformValue> findPlatformsByIpAddr( AuthzSubject subject,String addr,PageControl pc ) throws PermissionException;
    ...
    */
   public void updatePlatformTypes( String plugin,org.hyperic.hq.product.PlatformTypeInfo[] infos ) throws CreateException, FinderException, RemoveException, VetoException;
