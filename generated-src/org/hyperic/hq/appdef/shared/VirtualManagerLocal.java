 ...
 */
public interface VirtualManagerLocal
   extends javax.ejb.EJBLocalObject
{
    ...
    */
   public java.util.List findVirtualPlatformsByVM( org.hyperic.hq.authz.server.session.AuthzSubject subject,java.lang.Integer vmId ) throws org.hyperic.hq.appdef.shared.PlatformNotFoundException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Find virtual servers in a VM Process
    * @return a list of virtual server values
    */
   public java.util.List findVirtualServersByVM( org.hyperic.hq.authz.server.session.AuthzSubject subject,java.lang.Integer vmId ) throws org.hyperic.hq.appdef.shared.ServerNotFoundException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Find virtual services in a VM Process
    * @return a list of virtual service values
    */
   public java.util.List findVirtualServicesByVM( org.hyperic.hq.authz.server.session.AuthzSubject subject,java.lang.Integer vmId ) throws org.hyperic.hq.appdef.shared.ServiceNotFoundException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Find virtual resources whose parent is the given physical ID
    * @return list of virtual resource values
    */
   public java.util.List findVirtualResourcesByPhysical( org.hyperic.hq.authz.server.session.AuthzSubject subject,org.hyperic.hq.appdef.shared.AppdefEntityID aeid ) throws org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Associate an array of entities to a VM
    */
   public void associateEntities( org.hyperic.hq.authz.server.session.AuthzSubject subj,java.lang.Integer processId,org.hyperic.hq.appdef.shared.AppdefEntityID[] aeids ) throws javax.ejb.FinderException;

   /**
    * Associate an array of entities to a VM
    * @throws FinderException
    */
   public void associateToPhysical( org.hyperic.hq.authz.server.session.AuthzSubject subj,java.lang.Integer physicalId,org.hyperic.hq.appdef.shared.AppdefEntityID aeid ) throws javax.ejb.FinderException;
