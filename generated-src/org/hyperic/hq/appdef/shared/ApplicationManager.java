...
public interface ApplicationManager
{
    ...
    */
   public Application createApplication( AuthzSubject subject,ApplicationValue newApp,Collection<ServiceValue> services ) throws ValidationException, PermissionException, CreateException, AppdefDuplicateNameException;

   /**
    * Update the basic properties of an application. Will NOT update service dependencies, etc.
    */
   public ApplicationValue updateApplication( AuthzSubject subject,ApplicationValue newValue ) throws ApplicationNotFoundException, PermissionException, UpdateException, org.hyperic.hq.appdef.shared.AppdefDuplicateNameException, javax.ejb.FinderException;

   /**
    * Remove an application
    */
   public void removeApplication( AuthzSubject subject,Integer id ) throws ApplicationNotFoundException, PermissionException, RemoveException, VetoException;
    ...
    * @param subject
    * @param appId    */
   public DependencyTree getServiceDepsForApp( AuthzSubject subject,Integer pk ) throws org.hyperic.hq.appdef.shared.ApplicationNotFoundException, PermissionException;
    ...
    * @param depTree
    * @param subject    */
   public void setServiceDepsForApp( AuthzSubject subject,DependencyTree depTree ) throws ApplicationNotFoundException, RemoveException, PermissionException, CreateException;

   /**
    * Get application pojo by id.
    */
   public Application findApplicationById( AuthzSubject subject,Integer id ) throws ApplicationNotFoundException, PermissionException;
   ...
   public PageList<ApplicationValue> getAllApplications( AuthzSubject subject,PageControl pc ) throws FinderException, PermissionException;
    ...
    */
   public List<AppServiceValue> getApplicationServices( AuthzSubject subject,Integer appId ) throws org.hyperic.hq.appdef.shared.ApplicationNotFoundException, PermissionException;
    ...
    */
   public void setApplicationServices( AuthzSubject subject,Integer appId,java.util.List<AppdefEntityID> entityIds ) throws ApplicationNotFoundException, CreateException, AppdefGroupNotFoundException, PermissionException;

   /**
    * Get all applications for a resource.
    */
   public org.hyperic.util.pager.PageList<ApplicationValue> getApplicationsByResource( AuthzSubject subject,AppdefEntityID resource,PageControl pc ) throws ApplicationNotFoundException, PermissionException;
