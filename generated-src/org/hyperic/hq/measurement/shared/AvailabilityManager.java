...
public interface AvailabilityManager
{
   ...
   public Map<Integer,List<Measurement>>  getAvailMeasurementChildren( List<Integer>  resourceIds,String  resourceRelationType ) ;

   public List<Measurement>  getAvailMeasurementParent( Resource  resource,String  resourceRelationType ) ;

   public Map<Integer,List<Measurement>>  getAvailMeasurementParent( List<Integer>  resourceIds,String  resourceRelationType ) ;

   /**
    * TODO: Can this method be combined with the one that takes an array?
    */
   public PageList<HighLowMetricValue>  getHistoricalAvailData( Measurement  m,long begin,long end,PageControl  pc,boolean prependUnknowns ) ;
    ...
    */
   public PageList<HighLowMetricValue>  getHistoricalAvailData( Integer [] mids,long begin,long end,long interval,PageControl  pc,boolean prependUnknowns ) ;
