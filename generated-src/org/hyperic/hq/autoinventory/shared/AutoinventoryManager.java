...
/**
 * Remote interface for AutoinventoryManager.
 */
   ...
   extends javax.ejb.EJBObject
{
    ...
    */
   public java.util.Map getServerSignatures( org.hyperic.hq.authz.server.session.AuthzSubject subject,java.util.List serverTypes )
      throws javax.ejb.FinderException, org.hyperic.hq.autoinventory.AutoinventoryException, java.rmi.RemoteException;
    ...
    */
   public void turnOffRuntimeDiscovery( org.hyperic.hq.authz.server.session.AuthzSubject subject,org.hyperic.hq.appdef.shared.AppdefEntityID id )
    ...
    */
   public void turnOffRuntimeDiscovery( org.hyperic.hq.authz.server.session.AuthzSubject subject,org.hyperic.hq.appdef.shared.AppdefEntityID id,java.lang.String agentToken )
      throws org.hyperic.hq.authz.shared.PermissionException, java.rmi.RemoteException;

   /**
    * Toggle Runtime-AI config for the given server.
    */
   public void toggleRuntimeScan( org.hyperic.hq.authz.server.session.AuthzSubject subject,org.hyperic.hq.appdef.shared.AppdefEntityID id,boolean enable )
      throws org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.autoinventory.AutoinventoryException, org.hyperic.hq.authz.server.shared.ResourceDeletedException, java.rmi.RemoteException;
    ...
    */
   public void startScan( org.hyperic.hq.authz.server.session.AuthzSubject subject,org.hyperic.hq.appdef.shared.AppdefEntityID aid,org.hyperic.hq.autoinventory.ScanConfigurationCore scanConfig,java.lang.String scanName,java.lang.String scanDesc,org.hyperic.hq.scheduler.ScheduleValue schedule )
    ...
    */
   public void startScan( org.hyperic.hq.authz.server.session.AuthzSubject subject,java.lang.String agentToken,org.hyperic.hq.autoinventory.ScanConfigurationCore scanConfig )
      throws org.hyperic.hq.agent.AgentConnectionException, org.hyperic.hq.appdef.shared.AgentNotFoundException, org.hyperic.hq.autoinventory.AutoinventoryException, org.hyperic.hq.authz.shared.PermissionException, java.rmi.RemoteException;

   /**
    * Stop an autoinventory scan.
    * @param aid The appdef entity whose agent we'll talk to.
    */
   public void stopScan( org.hyperic.hq.authz.server.session.AuthzSubject subject,org.hyperic.hq.appdef.shared.AppdefEntityID aid )
      throws org.hyperic.hq.autoinventory.AutoinventoryException, java.rmi.RemoteException;

   /**
    * Get status for an autoinventory scan.
    * @param aid The appdef entity whose agent we'll talk to.
    */
   public org.hyperic.hq.autoinventory.ScanStateCore getScanStatus( org.hyperic.hq.authz.server.session.AuthzSubject subject,org.hyperic.hq.appdef.shared.AppdefEntityID aid )
      throws org.hyperic.hq.appdef.shared.AgentNotFoundException, org.hyperic.hq.agent.AgentConnectionException, org.hyperic.hq.agent.AgentRemoteException, org.hyperic.hq.autoinventory.AutoinventoryException, java.rmi.RemoteException;
    ...
    */
   public org.hyperic.hq.autoinventory.ScanStateCore getScanStatusByAgentToken( org.hyperic.hq.authz.server.session.AuthzSubject subject,java.lang.String agentToken )
      throws org.hyperic.hq.appdef.shared.AgentNotFoundException, org.hyperic.hq.agent.AgentConnectionException, org.hyperic.hq.agent.AgentRemoteException, org.hyperic.hq.autoinventory.AutoinventoryException, java.rmi.RemoteException;
    ...
    */
   public void reportAIData( java.lang.String agentToken,org.hyperic.hq.autoinventory.ScanStateCore stateCore )
      throws org.hyperic.hq.autoinventory.AutoinventoryException, java.rmi.RemoteException;
    ...
    */
   public void reportAIRuntimeReport( java.lang.String agentToken,org.hyperic.hq.autoinventory.CompositeRuntimeResourceReport crrr )
      throws org.hyperic.hq.autoinventory.AutoinventoryException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.ValidationException, org.hyperic.hq.common.ApplicationException, java.rmi.RemoteException;

   /**
    * Should only be called from RuntimePlatformAndServerMerger
    */
   public void _reportAIRuntimeReport( java.lang.String agentToken,org.hyperic.hq.autoinventory.CompositeRuntimeResourceReport crrr )
      throws org.hyperic.hq.autoinventory.AutoinventoryException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.ValidationException, org.hyperic.hq.common.ApplicationException, java.rmi.RemoteException;
    ...
    */
   public java.util.List mergePlatformsAndServers( java.lang.String agentToken,org.hyperic.hq.autoinventory.CompositeRuntimeResourceReport crrr )
      throws org.hyperic.hq.common.ApplicationException, org.hyperic.hq.autoinventory.AutoinventoryException, java.rmi.RemoteException;

   /**
    * Merge a list of {@link ServiceMergeInfo}s in HQ's appdef model
    */
   public void mergeServices( java.util.List mergeInfos )
      throws org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.common.ApplicationException, java.rmi.RemoteException;
