...
public interface ControlScheduleManager
{
    ...
    */
   public PageList<ControlHistory> getRecentControlActions( AuthzSubject subject,int rows,long window ) throws ApplicationException;

   /**
    * Get a list of pending control actions in decending order
    */
   public PageList<ControlSchedule> getPendingControlActions( AuthzSubject subject,int rows ) throws ApplicationException;

   /**
    * Get a list of most active control operations
    */
   public PageList<ControlFrequencyValue> getOnDemandControlFrequency( AuthzSubject subject,int numToReturn ) throws ApplicationException;

   /**
    * Get a list of scheduled jobs based on appdef id
    */
   public PageList<ControlSchedule> findScheduledJobs( AuthzSubject subject,AppdefEntityID id,PageControl pc ) throws ScheduledJobNotFoundException;

   /**
    * Get a job history based on appdef id
    */
   public PageList<ControlHistory> findJobHistory( AuthzSubject subject,AppdefEntityID id,PageControl pc ) throws PermissionException, AppdefEntityNotFoundException, GroupNotCompatibleException;

   /**
    * Get a batch job history based on batchJobId and appdef id
    */
   public PageList<ControlHistory> findGroupJobHistory( AuthzSubject subject,int batchId,AppdefEntityID id,PageControl pc ) throws ApplicationException;
    ...
    */
   public void doSingleAction( AppdefEntityID id,AuthzSubject subject,String action,String args,int[] order ) throws PluginException;

   /**
    * Schedule an action on an appdef entity
    */
   public void doScheduledAction( AppdefEntityID id,AuthzSubject subject,String action,ScheduleValue schedule,int[] order ) throws PluginException, SchedulerException;

   /**
    * Create a control history entry
    */
   public ControlHistory createHistory( AppdefEntityID id,Integer groupId,Integer batchId,String subjectName,String action,String args,Boolean scheduled,long startTime,long stopTime,long scheduleTime,String status,String description,String errorMessage ) ;
