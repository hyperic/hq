...
public interface ControlManager {
    ...
    */
   public void doAction( AuthzSubject subject,AppdefEntityID id,String action,String args ) throws PluginException, PermissionException;

   /**
    * Execute a single control action on a given entity.
    */
   public void doAction( AuthzSubject subject,AppdefEntityID id,String action ) throws PluginException, PermissionException;

   /**
    * Schedule a new control action.
    */
   public void doAction( AuthzSubject subject,AppdefEntityID id,String action,ScheduleValue schedule ) throws PluginException, PermissionException, SchedulerException;

   /**
    * Single control action for a group of given entities.
    */
   public void doGroupAction( AuthzSubject subject,AppdefEntityID id,String action,String args,int[] order ) throws PluginException, PermissionException, AppdefEntityNotFoundException, GroupNotCompatibleException;

   /**
    * Schedule a single control action for a group of given entities.
    * @throws SchedulerException
    */
   public void doGroupAction( AuthzSubject subject,AppdefEntityID id,String action,int[] order,ScheduleValue schedule ) throws PluginException, PermissionException, SchedulerException, GroupNotCompatibleException, AppdefEntityNotFoundException;

   /**
    * Get the supported actions for an appdef entity from the local ControlPluginManager
    */
   public List<String> getActions( AuthzSubject subject,AppdefEntityID id ) throws PermissionException, PluginNotFoundException, AppdefEntityNotFoundException, GroupNotCompatibleException;
    ...
    */
   public List<AppdefEntityID> batchCheckControlPermissions( AuthzSubject caller,AppdefEntityID[] entities ) throws AppdefEntityNotFoundException, PermissionException;
