...
public interface EscalationManager
{
    ...
    */
   public Escalation createEscalation( String name,String description,boolean pauseAllowed,long maxWaitTime,boolean notifyAll,boolean repeat ) throws DuplicateObjectException;
    ...
    * @see Escalation for information on fields
    */
   public void updateEscalation( AuthzSubject subject,Escalation esc,String name,String description,boolean pauseAllowed,long maxWaitTime,boolean notifyAll,boolean repeat ) throws DuplicateObjectException, PermissionException;
    ...
    * @param pause TODO
    */
   public boolean acknowledgeAlert( AuthzSubject subject,EscalationAlertType type,Integer alertId,String moreInfo,long pause ) throws PermissionException;
    ...
    */
   public void fixAlert( AuthzSubject subject,EscalationAlertType type,Integer alertId,String moreInfo ) throws PermissionException;

   /**
    * Fix an alert, potentially sending out notifications. The state of the escalation will be terminated and the alert will be marked fixed.
    * @param subject Person who fixed the alert
    */
   public void fixAlert( AuthzSubject subject,EscalationAlertType type,Integer alertId,String moreInfo,boolean suppressNotification ) throws PermissionException;
