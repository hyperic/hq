   ...
   extends javax.ejb.EJBObject
{
   ...
   public org.hyperic.hq.autoinventory.shared.AIScheduleValue findScheduledJobById( int sessionId,java.lang.Integer id )
      throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.authz.shared.PermissionException, java.rmi.RemoteException;
   ...
   public void deleteAIJob( int sessionId,java.lang.Integer[] ids )
      throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.autoinventory.AutoinventoryException, java.rmi.RemoteException;
    ...
    */
   public java.util.Map getServerSignatures( int sessionID,java.util.List serverTypes )
      throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.autoinventory.AutoinventoryException, java.rmi.RemoteException;
    ...
    */
   public void startGroupScan( int sessionID,int groupID,org.hyperic.hq.autoinventory.ScanConfigurationCore scanConfig,java.lang.String scanName,java.lang.String scanDesc,org.hyperic.hq.scheduler.ScheduleValue schedule )
    ...
    * @param schedule Describes when the scan should be run. If this is null, then the scan is run as an immediate, one-time only scan.
    */
   public void startScan( int sessionID,int platformID,org.hyperic.hq.autoinventory.ScanConfigurationCore scanConfig,java.lang.String scanName,java.lang.String scanDesc,org.hyperic.hq.scheduler.ScheduleValue schedule )
      throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.autoinventory.AutoinventoryException, org.hyperic.hq.agent.AgentConnectionException, org.hyperic.hq.appdef.shared.AgentNotFoundException, org.hyperic.hq.autoinventory.DuplicateAIScanNameException, org.hyperic.hq.scheduler.ScheduleWillNeverFireException, java.rmi.RemoteException;

   public void startScan( int sessionID,java.lang.String agentToken,org.hyperic.hq.autoinventory.ScanConfigurationCore scanConfig )
    ...
    */
   public org.hyperic.hq.autoinventory.ScanStateCore getScanStatus( int sessionID,int platformID )
      throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AgentNotFoundException, org.hyperic.hq.agent.AgentConnectionException, org.hyperic.hq.agent.AgentRemoteException, org.hyperic.hq.autoinventory.AutoinventoryException, java.rmi.RemoteException;

   /**
    * Get status for a running autoinventory scan given the agentToken
    */
   public org.hyperic.hq.autoinventory.ScanStateCore getScanStatusByAgentToken( int sessionID,java.lang.String agentToken )
      throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AgentNotFoundException, org.hyperic.hq.agent.AgentConnectionException, org.hyperic.hq.agent.AgentRemoteException, org.hyperic.hq.autoinventory.AutoinventoryException, java.rmi.RemoteException;
    ...
    */
   public org.hyperic.util.pager.PageList getQueue( int sessionID,boolean showIgnored,boolean showPlaceholders,org.hyperic.util.pager.PageControl pc )
    ...
    * @return A List of AIPlatformValue objects representing the contents of the autoinventory queue.
    */
   public org.hyperic.util.pager.PageList getQueue( int sessionID,boolean showIgnored,boolean showPlaceholders,boolean showAlreadyProcessed,org.hyperic.util.pager.PageControl pc )
      throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, java.rmi.RemoteException;

   /**
    * Get details on a single platform from the AI queue, by aiplatformID
    */
   public org.hyperic.hq.appdef.shared.AIPlatformValue findAIPlatformById( int sessionID,int aiplatformID )
      throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, java.rmi.RemoteException;

   /**
    * Get details on a single platform from the AI queue, by FQDN
    */
   public org.hyperic.hq.appdef.shared.AIPlatformValue findAIPlatformByFqdn( int sessionID,java.lang.String fqdn )
      throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, java.rmi.RemoteException;

   /**
    * Get details on a single server from the AI queue, by serverID
    */
   public org.hyperic.hq.appdef.shared.AIServerValue findAIServerById( int sessionID,int serverID )
      throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, java.rmi.RemoteException;

   /**
    * Get details on a single server from the AI queue, by name
    */
   public org.hyperic.hq.appdef.shared.AIServerValue findAIServerByName( int sessionID,java.lang.String name )
      throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, java.rmi.RemoteException;

   /**
    * Get details on a single ip from the AI queue, by ipID
    */
   public org.hyperic.hq.appdef.shared.AIIpValue findAIIpById( int sessionID,int ipID )
      throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, java.rmi.RemoteException;

   /**
    * Get details on a single ip from the AI queue, by address
    */
   public org.hyperic.hq.appdef.shared.AIIpValue findAIIpByAddress( int sessionID,java.lang.String address )
      throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, java.rmi.RemoteException;
    ...
    */
   public void processQueue( int sessionID,java.util.List platformList,java.util.List serverList,java.util.List ipList,int action )
      throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.appdef.shared.AIQApprovalException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.ValidationException, java.rmi.RemoteException;
    ...
    */
   public void toggleRuntimeScan( org.hyperic.hq.authz.server.session.AuthzSubject subject,org.hyperic.hq.appdef.shared.AppdefEntityID id,boolean doEnable )
    ...
    */
   public org.hyperic.hq.appdef.shared.AIPlatformValue findAIPlatformByPlatformID( int sessionId,java.lang.Integer platformID )
      throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.PlatformNotFoundException, java.rmi.RemoteException;
