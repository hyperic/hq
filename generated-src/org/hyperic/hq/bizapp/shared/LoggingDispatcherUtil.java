...
/**
 * Utility class for LoggingDispatcher.
 */
public class LoggingDispatcherUtil
{
  ...
  private static final java.lang.String CONNECTION_FACTORY_JNDI_NAME="";
    ...
    * @return Destination JMS Queue for LoggingDispatcher. Lookup using JNDI_NAME
    */
   ...
   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Connection Factory for LoggingDispatcher. Lookup using JNDI_NAME
    */
