...
public interface ControlBoss {
   ...
   public void doAction( int sessionId,AppdefEntityID id,String action,String args ) throws PluginException, GroupNotCompatibleException, SessionNotFoundException, SessionTimeoutException, PermissionException, AppdefEntityNotFoundException;
   ...
   public void doAction( int sessionId,AppdefEntityID id,String action,ScheduleValue schedule ) throws PluginException, SchedulerException, SessionNotFoundException, SessionTimeoutException, PermissionException, AppdefEntityNotFoundException, GroupNotCompatibleException, ApplicationException;

   /**
    * Schedule a control action on a group entity.
    * @param action The action to perform    */
   public void doGroupAction( int sessionId,AppdefEntityID groupEnt,String action,int[] orderSpec,ScheduleValue schedule ) throws PluginException, SchedulerException, SessionNotFoundException, SessionTimeoutException, PermissionException, AppdefEntityNotFoundException, GroupNotCompatibleException, ApplicationException;

   /**
    * Execute a control action immediately on a group entity.
    * @param action The action to perform    */
   public void doGroupAction( int sessionId,AppdefEntityID groupEnt,String action,String args,int[] orderSpec ) throws PluginException, GroupNotCompatibleException, SessionNotFoundException, SessionTimeoutException, PermissionException, AppdefEntityNotFoundException;

   /**
    * Get the actions supported for an appdef entity
    */
   public List getActions( int sessionId,AppdefEntityID id ) throws PluginNotFoundException, AppdefEntityNotFoundException, SessionNotFoundException, SessionTimeoutException, PermissionException, GroupNotCompatibleException;

   /**
    * Get the actions supported for an appdef entity type
    */
   public List getActions( int sessionId,AppdefEntityTypeID aetid ) throws PluginNotFoundException, PermissionException, SessionNotFoundException, SessionTimeoutException;
   ...
   public void deleteJobHistory( int sessionId,Integer[] ids ) throws ApplicationException, PermissionException, SessionNotFoundException, SessionTimeoutException;
   ...
   public ControlHistory getJobByJobId( int sessionId,Integer id ) throws ApplicationException, PermissionException, SessionNotFoundException, SessionTimeoutException;
   ...
   public ControlSchedule getControlJob( int sessionId,Integer id ) throws PluginException, ApplicationException, PermissionException, SessionNotFoundException, SessionTimeoutException;

   /**
    * Delete a ControlJob based on an id
    * @param ids Array of job ids to be deleted    */
   public void deleteControlJob( int sessionId,Integer[] ids ) throws PluginException, ApplicationException, PermissionException, SessionNotFoundException, SessionTimeoutException;
    ...
    */
   public PageList getRecentControlActions( String user,int rows,long window ) throws LoginException, ApplicationException;

   /**
    * Get a list of pending control actions in decending order
    */
   public PageList getPendingControlActions( int sessionId,int rows ) throws ApplicationException, PermissionException, SessionNotFoundException, SessionTimeoutException;
    ...
    */
   public List batchCheckControlPermissions( int sessionId,AppdefEntityID[] entities ) throws AppdefEntityNotFoundException, PermissionException, SessionNotFoundException, SessionTimeoutException;
    ...
    */
   public Map findControllablePlatformTypes( int sessionID ) throws SessionNotFoundException, SessionTimeoutException, PermissionException;
    ...
    * @throws PermissionException
    */
   public Map findControllableServerTypes( int sessionID ) throws SessionNotFoundException, SessionTimeoutException, PermissionException;
    ...
    * @throws PermissionException
    */
   public Map findControllableServiceTypes( int sessionID ) throws SessionNotFoundException, SessionTimeoutException, PermissionException;
    ...
    * @throws PermissionException
    */
   public Map findControllableResourceNames( int sessionID,AppdefEntityTypeID aetid ) throws SessionNotFoundException, SessionException, PermissionException;
