...
public interface AlertDefinitionManager
{
    ...
    */
   public AlertDefinitionValue updateAlertDefinition(AlertDefinitionValue adval ) throws AlertConditionCreateException,ActionCreateException,RemoveException;
    ...
    * Activate/deactivate an alert
    */
   public void updateAlertDefinitionActiveStatus(AuthzSubject subj,org.hyperic.hq.events.server.session.AlertDefinition def,boolean activate ) throws PermissionException;

   /**
    * Enable/Disable an alert For internal use only where the mtime does not need to be reset on each
    * @return <code>true</code> if the enable/disable
    */
   public boolean updateAlertDefinitionInternalEnable(AuthzSubject subj,org.hyperic.hq.events.server.session.AlertDefinition def,boolean enable ) throws PermissionException;

   /**
    * Enable/Disable an alert For internal use only where the mtime does not need to be reset on each
    * @return <code>true</code> if the enable/disable
    */
   public boolean updateAlertDefinitionInternalEnable(AuthzSubject subj,java.lang.Integer defId,boolean enable ) throws FinderException,PermissionException;
    ...
    */
   public void deleteAlertDefinitions(AuthzSubject subj,java.lang.Integer[] ids ) throws RemoveException,PermissionException;
   ...
   /**
    * Find an alert definition and return a basic This is called by the abstract trigger, so it does no permission
    ...
    * @param id The alert def
    * @return <code>true</code> if the alert definition is a resource type alert
    ...
    * @param allowStale <code>true</code> to allow stale copies of an alert definition in the query results; <code>false</code> to never allow stale copies, potentially always forcing a sync with the
    * @return The alert definition ID or <code>null</code> if no alert definition is found for the
    */
    ...
    * @param excludeTypeBased If true, exclude any alert definitions associated with a type-based
    * @param pInfo Paging The sort field must be a value from {@link AlertDefSortField}
    */
   public List<AlertDefinition> findAlertDefinitions(AuthzSubject subj,org.hyperic.hq.events.AlertSeverity minSeverity,java.lang.Boolean enabled,boolean excludeTypeBased,org.hyperic.hibernate.PageInfo pInfo ) ;
    ...
    * @param pInfo Paging The sort field must be a value from {@link AlertDefSortField}
    */
   public List<AlertDefinition> findTypeBasedDefinitions(AuthzSubject subj,java.lang.Boolean enabled,org.hyperic.hibernate.PageInfo pInfo ) throws PermissionException;

   /**
    * Get list of alert definition POJOs for a resource
    * @throws PermissionException if user cannot manage alerts for resource
    */
   public List<AlertDefinition> findAlertDefinitions(AuthzSubject subject,org.hyperic.hq.appdef.shared.AppdefEntityID id ) throws PermissionException;

   public PageList<AlertDefinition> findAlertDefinitions(AuthzSubject subj,org.hyperic.hq.appdef.shared.AppdefEntityID id,org.hyperic.util.pager.PageControl pc ) throws PermissionException;

   /**
    * Get list of alert definitions for a resource
    */
   public List<AlertDefinition> findAlertDefinitions(AuthzSubject subject,org.hyperic.hq.authz.server.session.Resource prototype ) throws PermissionException;

   /**
    * Get list of alert conditions for a resource or resource type
    */
   public PageList<AlertDefinition> findAlertDefinitions(AuthzSubject subj,org.hyperic.hq.appdef.shared.AppdefEntityTypeID aetid,org.hyperic.util.pager.PageControl pc ) throws PermissionException;
    ...
    */
   public List<AlertDefinition> findRelatedAlertDefinitions(AuthzSubject subj,org.hyperic.hq.authz.server.session.Resource res ) ;
    ...
    */
   public SortedMap<String,Integer> findAlertDefinitionNames(AuthzSubject subj,org.hyperic.hq.appdef.shared.AppdefEntityID id,java.lang.Integer parentId ) throws PermissionException;
