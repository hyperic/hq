 ...
 *
 */
public class MeasurementTemplateLiteValue
   ...
   implements java.io.Serializable
{
   ...
   public MeasurementTemplateLiteValue() {}

   public MeasurementTemplateLiteValue( Integer id,String name,String alias,String units,int collectionType,boolean defaultOn,long defaultInterval,boolean designate,String template,byte[] expressionData,java.lang.String plugin )
   {
	  this.id = id;
	  idHasBeenSet = true;
	  this.name = name;
   ...
   public MeasurementTemplateLiteValue( MeasurementTemplateLiteValue otherValue )
   {
   ...
   public String toString()
   {
	  ...
	  str.append("id=" + getId() + " " + "name=" + getName() + " " + "alias=" + getAlias() + " " + "units=" + getUnits() + " " + "collectionType=" + getCollectionType() + " " + "defaultOn=" + getDefaultOn() + " " + "defaultInterval=" + getDefaultInterval() + " " + "designate=" + getDesignate() + " " + "template=" + getTemplate() + " " + "expressionData=" + getExpressionData() + " " + "plugin=" + getPlugin());
	  str.append('}');
   ...
   public boolean equals(Object other)
   {
	  ...
	  if (other instanceof MeasurementTemplateLiteValue)
	  {
		 MeasurementTemplateLiteValue that = (MeasurementTemplateLiteValue) other;
