               ...
               XmlTagEntryHandler, XmlTagExitHandler
{
    ...
    AgentConnTag(XmlPlatformValue platVal){
        String[] required, optional;

        required       = XmlAgentConnValue.getRequiredAttributes();
        optional       = XmlAgentConnValue.getOptionalAttributes();
    ...
    public void enter(){
        ...
        this.agentConn = new XmlAgentConnValue();
    }

    public void exit(){
        this.platVal.setAgentConn(this.agentConn);
        this.agentConn = null;
    }
}
