...
class GroupTag
    implements XmlAttrHandler, XmlTagHandler, 
               ...
               XmlEndAttrHandler
{
    static final String TAG_NAME = "group";

    private XmlAttr[]       attrs;
    private XmlGroupValue     groupValue;   // Current working group
    private List                 groupList;    // List to add groups to

    GroupTag(List groupList){
        String[] required, optional;
        
        required       = XmlGroupValue.getRequiredAttributes();
        optional       = XmlGroupValue.getOptionalAttributes();
    ...
    public XmlTagInfo[] getSubTags(){
        return new XmlTagInfo[] {
            new XmlTagInfo(new GroupMemberTag(this.groupValue),
    ...
    public void enter(){
        ...
        this.groupValue = new XmlGroupValue();
    }
    ...
    public void exit(){
        ...
        this.groupList.add(this.groupValue);
