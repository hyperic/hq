...
public class FindAllServiceTypesFetcher 
    extends GenericEJBFetcher
{
    private AppdefBoss boss;
    private int        authToken;

    public FindAllServiceTypesFetcher(AppdefBoss boss, int authToken){
        this.boss      = boss;
    ...
    {
        try {
            return this.boss.findAllServiceTypes(this.authToken, control);
        } catch(Exception exc){
