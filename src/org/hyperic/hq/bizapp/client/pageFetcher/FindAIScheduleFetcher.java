...
public class FindAIScheduleFetcher extends GenericEJBFetcher {

    private AppdefEntityID id;
    private AIBoss         boss;
    private int            authToken;
    
    public FindAIScheduleFetcher(AIBoss boss, int authToken,
                                 AppdefEntityID id) {
        this.boss      = boss;
    ...
    {
        try {
            return this.boss.findScheduledJobs(this.authToken, this.id, pc);
