...
public class ClientShell_trigger extends MultiwordShellCommand {
    private ClientShellAuthenticator auth        = null;
    private ClientShell              shell       = null;
    private EventsBoss            eventsBoss  = null;

    public ClientShell_trigger (ClientShell shell) {
        this.shell = shell;
    }
        ...
        throws ShellCommandInitException 
    {
        ...
        registerSubHandler("add",  
                           new ClientShell_trigger_add(this, this.auth));
        registerSubHandler("list", 
                           new ClientShell_trigger_list(this, this.auth));
    }

    public String getUsageShort(){
        return "List and add triggers";
    }
    ...
    public String getUsageHelp(String args[]) {
        ...
        return "trigger <add | connect | delete | list>\n" +
            "  Add, connect, delete, and list triggers\n" +
            "  for specific help, use 'help trigger add', etc.";
    }
