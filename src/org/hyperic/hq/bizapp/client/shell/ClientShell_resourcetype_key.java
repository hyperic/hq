...
public class ClientShell_resourcetype_key
    extends MultiwordShellCommand 
{
    private ClientShell shell;

    public ClientShell_resourcetype_key(ClientShell shell){
        this.shell = shell;
    }
        ...
        throws ShellCommandInitException 
    {
        ...
        handler = new ClientShell_resourcetype_key_add(this.shell);
        registerSubHandler("add", handler);
        handler = new ClientShell_resourcetype_key_delete(this.shell);
        registerSubHandler("delete", handler);
    }

    public String getUsageShort(){
        return "Manipulate custom resource keys";
    }
}
