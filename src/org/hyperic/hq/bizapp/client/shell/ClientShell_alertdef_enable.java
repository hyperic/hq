...
public class ClientShell_alertdef_enable extends ShellCommandBase {
    private ClientShellEntityFetcher _entityFetcher;

    public ClientShell_alertdef_enable(ClientShell shell){
        _entityFetcher = 
    ...
    public String getUsageShort(){
        return "Enable an alert definition";
    }
