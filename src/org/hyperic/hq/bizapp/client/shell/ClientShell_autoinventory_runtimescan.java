...
public class ClientShell_autoinventory_runtimescan
    ...
    public String getUsageHelp(String[] args) {
        return "    " + this.getUsageShort() + ".\n\n" +
            ...
            "      " + this.getCommandName() + " <enable | disable> <" +
    ...
    public void processCommand(String[] args) 
        ...
        try {
            id  = this.entityFetcher.getID(type, args[2]);
        } catch (Exception e) {
        ...
        try {
            this.entityFetcher.toggleRuntimeScan(id, doEnable);
        } catch (Exception e) {
            this.getErrStream().println("Unable to " + action.toLowerCase()
