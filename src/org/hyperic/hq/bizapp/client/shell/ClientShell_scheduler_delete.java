...
public class ClientShell_scheduler_delete extends MultiwordShellCommand {
    private ClientShell_scheduler owner;
    private ClientShellAuthenticator auth;

    public ClientShell_scheduler_delete(ClientShell_scheduler owner,
        ...
        throws ShellCommandInitException
    {
        ...
        handler = new ClientShell_scheduler_delete_jobs(this, this.auth);
        registerSubHandler("jobs", handler);

        handler = new ClientShell_scheduler_delete_schedules(this, this.auth);
        registerSubHandler("schedules", handler);
    }

    public String getUsageHelp(String as[]) {
        return "scheduler delete < jobs | schedules >";
    }
