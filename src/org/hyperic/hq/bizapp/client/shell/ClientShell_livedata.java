...
public class ClientShell_livedata extends MultiwordShellCommand {

    private ClientShell shell;

    public ClientShell_livedata(ClientShell shell){
        this.shell = shell;
    }
    ...
    public void init(String commandName, ShellBase shell)
        ...
        handler = new ClientShell_livedata_get(this.shell);
        registerSubHandler("get", handler);

        handler = new ClientShell_livedata_list(this.shell);
