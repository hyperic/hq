...
public class ClientShell_alertdef_flush extends ShellCommandBase {
    private ClientShellEntityFetcher _entityFetcher;

    public ClientShell_alertdef_flush(ClientShell shell){
        _entityFetcher = 
    ...
    public String getUsageShort(){
        return "Flush alert definition related caches";
    }
