...
public class ClientShell_resourcetype
    extends MultiwordShellCommand 
{
    private ClientShell              shell;

    public ClientShell_resourcetype(ClientShell shell){
        this.shell = shell;
    }
        ...
        throws ShellCommandInitException 
    {
        ...
        handler = new ClientShell_resourcetype_list(this.shell);
        registerSubHandler("list", handler);
        handler = new ClientShell_resourcetype_view(this.shell);
        registerSubHandler("view", handler);
        handler = new ClientShell_resourcetype_key(this.shell);
        registerSubHandler("key", handler);
    }

    public String getUsageShort(){
        return "View " + ClientShell.PRODUCT + " resource types";
    }
}
