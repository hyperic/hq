...
public class TabBodyAction extends BaseAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if (id != null) {
			//TODO : change this to a lookup for runtime deployment
			// Look up the Attachment bean
			Collection attachments = (Collection) request.getSession()
					.getAttribute("mastheadAttachments");
			for (Iterator it = attachments.iterator(); it.hasNext();) {
				...
				if (attach.getId().equals(id)) {
					...
					request.setAttribute("attachment", pBoss.findViewById(
