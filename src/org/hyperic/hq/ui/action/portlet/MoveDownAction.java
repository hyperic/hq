...
public class MoveDownAction extends BaseAction {
    ...
    private static final Log log
        = LogFactory.getLog(MoveDownAction.class.getName());
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        if (!tryMoveDown(user, portlet, session,
                         Constants.USER_PORTLETS_FIRST, az) &&
            !tryMoveDown(user, portlet, session, 
    ...
    private boolean tryMoveDown (WebUser user, String portlet, 
        ...
        while (st.hasMoreTokens()) {
            ...
            if (token.equals(portlet)) {
                ...
                newColumn.append(delim).append(nextToken)
                    .append(delim).append(token);
            } else {
