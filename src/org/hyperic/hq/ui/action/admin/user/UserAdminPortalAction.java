...
public class UserAdminPortalAction extends BaseDispatchAction {
    ...
    private static final String TITLE_CHANGE_PASSWORD =
        "admin.user.ChangeUserPasswordTitle";
    private static final String PORTLET_CHANGE_PASSWORD =
    ...
    public ActionForward addUserRoles(ActionMapping mapping,
                                      ActionForm form,
                                      HttpServletRequest request,
                                      HttpServletResponse response)
        throws Exception {
        ...
        Portal portal = Portal.createPortal(TITLE_ADD_ROLES,
                                            PORTLET_ADD_ROLES);
    ...
    public ActionForward changeUserPassword(ActionMapping mapping,
                                            ActionForm form,
                                            HttpServletRequest request,
                                            HttpServletResponse response)
        throws Exception {
        ...
        Portal portal = Portal.createPortal(TITLE_CHANGE_PASSWORD,
                                            PORTLET_CHANGE_PASSWORD);
        portal.setDialog(true);
        request.setAttribute(Constants.PORTAL_KEY, portal);
    ...
    public ActionForward registerUser(ActionMapping mapping,
                                      ActionForm form,
                                      HttpServletRequest request,
                                      HttpServletResponse response)
        throws Exception {
     ...
     * 
     * @param request The request to get the session to store the
     * return path into.
