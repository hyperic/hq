 ...
 * monitor portals.
 */
public class ServerVisibilityPortalAction extends ResourceVisibilityPortalAction {
    ...
    private static final String TITLE_FAVORITE_METRICS =
        "resource.server.monitor.visibility.FavoriteMetricsTitle";

    private static final String PORTLET_FAVORITE_METRICS =
        ".resource.server.monitor.visibility.FavoriteMetrics";
    ...
    protected static Log log =
        LogFactory.getLog(ServerVisibilityPortalAction.class.getName());

    protected Properties getKeyMethodMap() {
        Properties map = new Properties();
        map.put(Constants.MODE_MON_CUR,         "currentHealth");
        map.put(Constants.MODE_MON_RES_METS,    "resourceMetrics");
        map.put(Constants.MODE_MON_PERF,        "performance");
        return map;
    }
