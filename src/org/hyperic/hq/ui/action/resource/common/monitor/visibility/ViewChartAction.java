...
public class ViewChartAction extends MetricDisplayRangeAction {
    ...
    protected void _saveUserChart(String url, String name,
        ...
        String charts = userDashPrefs.getValue(Constants.USER_DASHBOARD_CHARTS);
        ...
        userDashPrefs.getValue(Constants.USER_DASHBOARD_CHARTS, charts);
        if (LogFactory.getLog("user.preferences").isTraceEnabled()) {
            LogFactory.getLog("user.preferences").trace(
                "Invoking setUserPrefs" + " in ViewChartAction " + " for "
