...
public class TablePropertyTag extends TemplateTag {
    ...
    /** Holds value of property includeTotals.
     * should the tage generate total list size for the user.
     */
    ...
    /** getter for var. var is a value that points to the current data cell
     * in the page scope, very jstl-esque.
     */
    public String getVar() {
        return this.var;
    }
    
    /** setter for var. var is a value that points to the curent data cell
     * in the page scope, very jstl-esque.
     */
    ...
    public void setPageSize(String v) { pageSize = v; }
    public void setOrder(String v) { order = v; }
     ...
     * @param sortValue New value of property sortValue.
     *
     */
     ...
     * @param pageSizeValue New value of property pageSizeValue.
     *
     */
