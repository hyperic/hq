...
public class ColumnTag extends BodyTagSupport implements Cloneable {
    ...
    public void setDecorator(ColumnDecorator v) {this.decorator = v; }
    ...
    public ColumnDecorator getDecorator() { return this.decorator ;}
    ...
    public int doEndTag() throws JspException {
        ...
        Object parent = this.findAncestorWithClass(this, clazz);
