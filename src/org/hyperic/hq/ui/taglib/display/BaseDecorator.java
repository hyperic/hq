...
/**
 * This class is an abstract class for decorators to inherit from
 * for implementing decorators for columns.
 */
public abstract class BaseDecorator 
    extends ColumnDecorator implements Tag
{

    private static Log log = LogFactory.getLog(BaseDecorator.class.getName());
    
    /**
     *  The main method to override here. This should look something like
     * this: 
     * <code>
     *
     *  String name = null;
    ...
    protected Object evalAttr(String name, String value, Class type)
        ...
        return ExpressionUtil.evalNotNull("spiderdecorator", name, value,
                                          type, this, getPageContext());
    }
