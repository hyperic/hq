...
/**
 * A JSP tag that will take a java.util.List and format it using a
...
public class ListJoinTag extends TagSupport {
    ...
    /**
     * Set the value of the list item delimiter (what will be printed
     * between list items).
     *
     ...
     * This is useful if the list contains objects that are not
     * primitive types, but are instead java beans.
     *
    ...
    public final int doStartTag() throws JspException {
        try {
            List list = (List)ExpressionUtil.evalNotNull("listJoin", "list", this.list,
                                                         List.class, this, pageContext);

            String property = (String)ExpressionUtil.evalNotNull("listJoin", "property",
                                                                 this.property, String.class,
                                                                 this, pageContext);
            ...
            for (Iterator it=list.iterator(); it.hasNext();) {
                if ( null == property || 0 == property.length() ) {
                    ...
                    try {
                        ...
                        Object value = m.invoke(bean, (Object[])null/* method args */);
