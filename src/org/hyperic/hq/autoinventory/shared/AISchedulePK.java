...
/**
 * Primary key for AISchedule.
 */
public class AISchedulePK
   ...
   implements java.io.Serializable
{
   ...
   public AISchedulePK( Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.autoinventory.shared.AISchedulePK) )
         return false;

      org.hyperic.hq.autoinventory.shared.AISchedulePK pk = (org.hyperic.hq.autoinventory.shared.AISchedulePK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.autoinventory.shared.AISchedulePK)obj).getId() == null )
         {
            eq = true;
         }
         else
