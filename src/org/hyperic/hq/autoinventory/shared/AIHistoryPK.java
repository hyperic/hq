...
/**
 * Primary key for AIHistory.
 */
public class AIHistoryPK
   ...
   implements java.io.Serializable
{
   ...
   {
      if( !(obj instanceof org.hyperic.hq.autoinventory.shared.AIHistoryPK) )
         return false;

      org.hyperic.hq.autoinventory.shared.AIHistoryPK pk = (org.hyperic.hq.autoinventory.shared.AIHistoryPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.autoinventory.shared.AIHistoryPK)obj).getId() == null )
         {
            eq = true;
         }
         else
