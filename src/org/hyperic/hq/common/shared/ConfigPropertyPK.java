...
/**
 * Primary key for ConfigProperty.
 */
public class ConfigPropertyPK
   ...
   implements java.io.Serializable
{
   ...
   public ConfigPropertyPK()
   {
   }

   public ConfigPropertyPK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.common.shared.ConfigPropertyPK) )
         return false;

      org.hyperic.hq.common.shared.ConfigPropertyPK pk = (org.hyperic.hq.common.shared.ConfigPropertyPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.common.shared.ConfigPropertyPK)obj).getId() == null )
         {
            eq = true;
         }
         else
