...
/**
 * Primary key for AIService.
 */
public class AIServicePK
   ...
   implements java.io.Serializable
{
   ...
   public AIServicePK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.AIServicePK) )
         return false;

      org.hyperic.hq.appdef.shared.AIServicePK pk = (org.hyperic.hq.appdef.shared.AIServicePK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.AIServicePK)obj).getId() == null )
         {
            eq = true;
         }
         else
