...
/**
 * Primary key for AppService.
 */
public class AppServicePK
   ...
   implements java.io.Serializable
{
   ...
   public AppServicePK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.AppServicePK) )
         return false;

      org.hyperic.hq.appdef.shared.AppServicePK pk = (org.hyperic.hq.appdef.shared.AppServicePK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.AppServicePK)obj).getId() == null )
         {
            eq = true;
         }
         else
