...
/**
 * Primary key for ServerType.
 */
public class ServerTypePK
   ...
   implements java.io.Serializable
{
   ...
   public ServerTypePK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.ServerTypePK) )
         return false;

      org.hyperic.hq.appdef.shared.ServerTypePK pk = (org.hyperic.hq.appdef.shared.ServerTypePK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.ServerTypePK)obj).getId() == null )
         {
            eq = true;
         }
         else
