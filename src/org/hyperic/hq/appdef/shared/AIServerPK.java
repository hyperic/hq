...
/**
 * Primary key for AIServer.
 */
public class AIServerPK
   ...
   implements java.io.Serializable
{
   ...
   public AIServerPK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.AIServerPK) )
         return false;

      org.hyperic.hq.appdef.shared.AIServerPK pk = (org.hyperic.hq.appdef.shared.AIServerPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.AIServerPK)obj).getId() == null )
         {
            eq = true;
         }
         else
