   ...
   implements java.io.Serializable
{
   ...
   public ApplicationPK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.ApplicationPK) )
         return false;

      org.hyperic.hq.appdef.shared.ApplicationPK pk = (org.hyperic.hq.appdef.shared.ApplicationPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.ApplicationPK)obj).getId() == null )
         {
            eq = true;
         }
         else
