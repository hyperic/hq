...
/**
 * Primary key for Server.
 */
public class ServerPK
   ...
   implements java.io.Serializable
{
   ...
   public ServerPK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.ServerPK) )
         return false;

      org.hyperic.hq.appdef.shared.ServerPK pk = (org.hyperic.hq.appdef.shared.ServerPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.ServerPK)obj).getId() == null )
         {
            eq = true;
         }
         else
