...
/**
 * Primary key for AIPlatform.
 */
public class AIPlatformPK
   ...
   implements java.io.Serializable
{
   ...
   public AIPlatformPK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.AIPlatformPK) )
         return false;

      org.hyperic.hq.appdef.shared.AIPlatformPK pk = (org.hyperic.hq.appdef.shared.AIPlatformPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.AIPlatformPK)obj).getId() == null )
         {
            eq = true;
         }
         else
