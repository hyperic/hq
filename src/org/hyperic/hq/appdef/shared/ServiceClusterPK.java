...
/**
 * Primary key for ServiceCluster.
 */
public class ServiceClusterPK
   ...
   implements java.io.Serializable
{
   ...
   public ServiceClusterPK()
   {
   }

   public ServiceClusterPK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.ServiceClusterPK) )
         return false;

      org.hyperic.hq.appdef.shared.ServiceClusterPK pk = (org.hyperic.hq.appdef.shared.ServiceClusterPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.ServiceClusterPK)obj).getId() == null )
         {
            eq = true;
         }
         else
