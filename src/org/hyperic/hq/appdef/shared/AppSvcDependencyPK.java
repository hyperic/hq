...
/**
 * Primary key for AppSvcDependency.
 */
public class AppSvcDependencyPK
   ...
   implements java.io.Serializable
{
   ...
   public AppSvcDependencyPK()
   {
   }

   public AppSvcDependencyPK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.AppSvcDependencyPK) )
         return false;

      org.hyperic.hq.appdef.shared.AppSvcDependencyPK pk = (org.hyperic.hq.appdef.shared.AppSvcDependencyPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.AppSvcDependencyPK)obj).getId() == null )
         {
            eq = true;
         }
         else
