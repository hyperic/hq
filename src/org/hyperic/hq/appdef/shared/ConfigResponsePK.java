...
/**
 * Primary key for ConfigResponse.
 */
public class ConfigResponsePK
   ...
   implements java.io.Serializable
{
   ...
   public ConfigResponsePK()
   {
   }

   public ConfigResponsePK( Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.ConfigResponsePK) )
         return false;

      org.hyperic.hq.appdef.shared.ConfigResponsePK pk = (org.hyperic.hq.appdef.shared.ConfigResponsePK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.ConfigResponsePK)obj).getId() == null )
         {
            eq = true;
         }
         else
