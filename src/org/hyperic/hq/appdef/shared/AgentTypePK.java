...
/**
 * Primary key for AgentType.
 */
public class AgentTypePK
   ...
   implements java.io.Serializable
{
   ...
   public AgentTypePK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.AgentTypePK) )
         return false;

      org.hyperic.hq.appdef.shared.AgentTypePK pk = (org.hyperic.hq.appdef.shared.AgentTypePK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.AgentTypePK)obj).getId() == null )
         {
            eq = true;
         }
         else
