   ...
   implements java.io.Serializable
{
   ...
   public ServicePK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.ServicePK) )
         return false;

      org.hyperic.hq.appdef.shared.ServicePK pk = (org.hyperic.hq.appdef.shared.ServicePK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.ServicePK)obj).getId() == null )
         {
            eq = true;
         }
         else
