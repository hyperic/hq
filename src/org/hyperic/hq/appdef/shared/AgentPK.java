   ...
   implements java.io.Serializable
{
   ...
   public AgentPK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.AgentPK) )
         return false;

      org.hyperic.hq.appdef.shared.AgentPK pk = (org.hyperic.hq.appdef.shared.AgentPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.AgentPK)obj).getId() == null )
         {
            eq = true;
         }
         else
