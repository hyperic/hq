 ...
 *
 */
public class ServerLightValue extends AppdefResourceValue
    implements java.io.Serializable
{
    ...
    public ServerLightValue( ServerLightValue otherValue )
    {
    ...
    public boolean equals(Object other)
    {
        ...
        if (other instanceof ServerLightValue)
        {
            ServerLightValue that = (ServerLightValue) other;
