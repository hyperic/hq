...
/**
 * Primary key for CPropKey.
 */
public class CPropKeyPK
   ...
   implements java.io.Serializable
{
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.CPropKeyPK) )
         return false;

      org.hyperic.hq.appdef.shared.CPropKeyPK pk = (org.hyperic.hq.appdef.shared.CPropKeyPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.CPropKeyPK)obj).getId() == null )
         {
            eq = true;
         }
         else
