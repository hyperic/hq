   ...
   implements java.io.Serializable
{
   ...
   public AIIpPK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.AIIpPK) )
         return false;

      org.hyperic.hq.appdef.shared.AIIpPK pk = (org.hyperic.hq.appdef.shared.AIIpPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.AIIpPK)obj).getId() == null )
         {
            eq = true;
         }
         else
