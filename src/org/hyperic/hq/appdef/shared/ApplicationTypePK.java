...
/**
 * Primary key for ApplicationType.
 */
public class ApplicationTypePK
   ...
   implements java.io.Serializable
{
   ...
   public ApplicationTypePK()
   {
   }

   public ApplicationTypePK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.ApplicationTypePK) )
         return false;

      org.hyperic.hq.appdef.shared.ApplicationTypePK pk = (org.hyperic.hq.appdef.shared.ApplicationTypePK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.ApplicationTypePK)obj).getId() == null )
         {
            eq = true;
         }
         else
