...
/**
 * Primary key for PlatformType.
 */
public class PlatformTypePK
   ...
   implements java.io.Serializable
{
   ...
   public PlatformTypePK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.PlatformTypePK) )
         return false;

      org.hyperic.hq.appdef.shared.PlatformTypePK pk = (org.hyperic.hq.appdef.shared.PlatformTypePK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.PlatformTypePK)obj).getId() == null )
         {
            eq = true;
         }
         else
