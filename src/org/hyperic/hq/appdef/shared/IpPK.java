   ...
   implements java.io.Serializable
{
   ...
   public IpPK( java.lang.Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.appdef.shared.IpPK) )
         return false;

      org.hyperic.hq.appdef.shared.IpPK pk = (org.hyperic.hq.appdef.shared.IpPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.appdef.shared.IpPK)obj).getId() == null )
         {
            eq = true;
         }
         else
