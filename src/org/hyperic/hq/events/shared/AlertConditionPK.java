...
/**
 * Primary key for AlertCondition.
 */
public class AlertConditionPK
   ...
   implements java.io.Serializable
{
   ...
   public AlertConditionPK()
   {
   }

   public AlertConditionPK( Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.events.shared.AlertConditionPK) )
         return false;

      org.hyperic.hq.events.shared.AlertConditionPK pk = (org.hyperic.hq.events.shared.AlertConditionPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.events.shared.AlertConditionPK)obj).getId() == null )
         {
            eq = true;
         }
         else
