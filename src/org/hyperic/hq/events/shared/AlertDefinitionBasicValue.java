 ...
 *
 */
public class AlertDefinitionBasicValue
   ...
   implements java.io.Serializable
{
   ...
   public AlertDefinitionBasicValue()
   {
   }

   public AlertDefinitionBasicValue( Integer id,String name,long ctime,long mtime,Integer parentId,java.lang.String description,boolean enabled,boolean willRecover,boolean notifyFiltered,boolean controlFiltered,int priority,int appdefId,int appdefType,int frequencyType,long count,long range,int actOnTriggerId,boolean deleted )
   {
	  this.id = id;
	  idHasBeenSet = true;
	  this.name = name;
   ...
   public AlertDefinitionBasicValue( AlertDefinitionBasicValue otherValue )
   {
   ...
   public void copyTriggersFrom(org.hyperic.hq.events.shared.AlertDefinitionBasicValue from)
   {
	  // TODO Clone the List ????
   ...
   public void copyConditionsFrom(org.hyperic.hq.events.shared.AlertDefinitionBasicValue from)
   {
	  // TODO Clone the List ????
   ...
   public void copyActionsFrom(org.hyperic.hq.events.shared.AlertDefinitionBasicValue from)
   {
	  // TODO Clone the List ????
   ...
   public boolean equals(Object other)
   {
	  ...
	  if (other instanceof AlertDefinitionBasicValue)
	  {
		 AlertDefinitionBasicValue that = (AlertDefinitionBasicValue) other;
