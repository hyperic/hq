...
/**
 * Primary key for AlertActionLog.
 */
public class AlertActionLogPK
   ...
   implements java.io.Serializable
{
   ...
   public AlertActionLogPK()
   {
   }

   public AlertActionLogPK( Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.events.shared.AlertActionLogPK) )
         return false;

      org.hyperic.hq.events.shared.AlertActionLogPK pk = (org.hyperic.hq.events.shared.AlertActionLogPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.events.shared.AlertActionLogPK)obj).getId() == null )
         {
            eq = true;
         }
         else
