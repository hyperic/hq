...
/**
 * Primary key for RegisteredTrigger.
 */
public class RegisteredTriggerPK
   ...
   implements java.io.Serializable
{
   ...
   public RegisteredTriggerPK()
   {
   }

   public RegisteredTriggerPK( Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.events.shared.RegisteredTriggerPK) )
         return false;

      org.hyperic.hq.events.shared.RegisteredTriggerPK pk = (org.hyperic.hq.events.shared.RegisteredTriggerPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.events.shared.RegisteredTriggerPK)obj).getId() == null )
         {
            eq = true;
         }
         else
