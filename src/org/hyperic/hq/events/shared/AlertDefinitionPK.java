...
/**
 * Primary key for AlertDefinition.
 */
public class AlertDefinitionPK
   ...
   implements java.io.Serializable
{
   ...
   public AlertDefinitionPK()
   {
   }

   public AlertDefinitionPK( Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.events.shared.AlertDefinitionPK) )
         return false;

      org.hyperic.hq.events.shared.AlertDefinitionPK pk = (org.hyperic.hq.events.shared.AlertDefinitionPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.events.shared.AlertDefinitionPK)obj).getId() == null )
         {
            eq = true;
         }
         else
