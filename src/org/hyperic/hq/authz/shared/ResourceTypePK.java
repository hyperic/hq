...
/**
 * Primary key for ResourceType.
 */
public class ResourceTypePK
   ...
   implements java.io.Serializable
{
   ...
   public ResourceTypePK( Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.authz.shared.ResourceTypePK) )
         return false;

      org.hyperic.hq.authz.shared.ResourceTypePK pk = (org.hyperic.hq.authz.shared.ResourceTypePK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.authz.shared.ResourceTypePK)obj).getId() == null )
         {
            eq = true;
         }
         else
