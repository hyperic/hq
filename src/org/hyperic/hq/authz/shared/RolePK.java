   ...
   implements java.io.Serializable
{
   ...
   {
      if( !(obj instanceof org.hyperic.hq.authz.shared.RolePK) )
         return false;

      org.hyperic.hq.authz.shared.RolePK pk = (org.hyperic.hq.authz.shared.RolePK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.authz.shared.RolePK)obj).getId() == null )
         {
            eq = true;
         }
         else
