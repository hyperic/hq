   ...
   implements java.io.Serializable
{
   ...
   {
      if( !(obj instanceof org.hyperic.hq.authz.shared.OperationPK) )
         return false;

      org.hyperic.hq.authz.shared.OperationPK pk = (org.hyperic.hq.authz.shared.OperationPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.authz.shared.OperationPK)obj).getId() == null )
         {
            eq = true;
         }
         else
