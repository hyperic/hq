...
/**
 * Primary key for ResourceGroup.
 */
public class ResourceGroupPK
   ...
   implements java.io.Serializable
{
   ...
   public ResourceGroupPK()
   {
   }

   public ResourceGroupPK( Integer id )
   {
      this.id = id;
   }
   ...
   {
      if( !(obj instanceof org.hyperic.hq.authz.shared.ResourceGroupPK) )
         return false;

      org.hyperic.hq.authz.shared.ResourceGroupPK pk = (org.hyperic.hq.authz.shared.ResourceGroupPK)obj;
      boolean eq = true;
      ...
      {
         if( this.id == null && ((org.hyperic.hq.authz.shared.ResourceGroupPK)obj).getId() == null )
         {
            eq = true;
         }
         else
