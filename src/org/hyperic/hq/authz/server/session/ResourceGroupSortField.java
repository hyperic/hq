    ...
    implements SortField
{
    ...
    private ResourceGroupSortField(int code, String desc, String localeProp) {
        super(ResourceGroupSortField.class, code, desc, localeProp,
     ...
     */
    abstract String getSortString(String group);
    
    public static ResourceGroupSortField findByCode(int code) {
        return (ResourceGroupSortField)
            HypericEnum.findByCode(ResourceGroupSortField.class, code); 
    }
}
