...
public class SNMPMeasurementPlugin extends MeasurementPlugin
{
                                                             ...
                                                             SNMPException e )
   {
      ...
      String cfg = props.getProperty ( SNMPClient.PROP_IP)    +
                   ":"                                        +
                                                        ...
                                                        PluginException
   {
    ...
    private int getIndex ( Properties  props,
                           SNMPSession session ) throws MetricUnreachableException,
                                                        MetricNotFoundException
   {
