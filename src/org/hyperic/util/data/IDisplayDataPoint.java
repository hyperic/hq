...
/**
 *
 * This interface defines APIs that are required to display a data point in
 * the UI
 */
public interface IDisplayDataPoint extends IDataPoint {
    ...
    /**
     * Retrieves the label of a chart data point. The data point is charted on
     * the X axis for line and column charts.
     *
