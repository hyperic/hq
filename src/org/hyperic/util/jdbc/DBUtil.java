...
public class DBUtil {
    ...
    /**
     * Make a string suitable for use as the target of a SQL 'in' clause.
     * 
     * I.e. select id from X where id in (1, 2, 3, 4, 5)
     * The (1, 2, 3, 4, 5) is generated by this method
     *
     * Caveat:  DBs do not support unlimited length IN sets, so don't pass
     *          in a huge array
     */
    public static String makeInSet(Object[] o) {
