...
public class TokenReplacerFilterInputStream_test extends TestCase {

    public TokenReplacerFilterInputStream_test () 
    {
        this("TokenReplacerFilterInputStream_test");
    }

    public TokenReplacerFilterInputStream_test(String name) 
    {
        super(name);
    }
    ...
    public static void main ( String[] args ) {
        try {
            TokenReplacerFilterInputStream_test test =
                new TokenReplacerFilterInputStream_test("main");
