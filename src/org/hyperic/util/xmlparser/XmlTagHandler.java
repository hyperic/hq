 ...
 * implement.  The TagHander provides information about the tags name,
 * and which subtags are valid.
 */
public interface XmlTagHandler {
    /**
     * Retrieve the name of the tag, without angled brackets. 
     * (i.e. "foo" for tags named <foo>)
     * 
     ...
     *
     * @return An array of tag information objects, indicating which subtags
     *         are valid.
     */
