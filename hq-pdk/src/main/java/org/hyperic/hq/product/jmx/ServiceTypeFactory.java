...
/**
 * Constructs a {@link ServiceType} object from a JMX {@link MBeanInfo}
 *
 * @author jhickey
 *
 */
public class ServiceTypeFactory {
    ...
    private void addMeasurements(final ServiceType serviceType,
            final ProductPlugin productPlugin, MBeanInfo serviceInfo) {
    ...
    public ServiceType create(ProductPlugin productPlugin,
            ServerTypeInfo serverType, MBeanInfo serviceInfo,
            ObjectName objectName) {
    ...
    public ServiceType getServiceType(String productName, ServerTypeInfo serverType,
            MBeanInfo serviceInfo, ObjectName objectName) {
        ...
        try {
            ...
            Descriptor serviceDescriptor = serviceInfo.getDescriptor();
