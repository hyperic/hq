...
execute('Appdef Load Run (low concurrency)', [
    [ task : allPlatformPagesTask, max_threads : 3, num_times : 10 ],                            
    [ task : allServerPagesTask,   max_threads : 3, num_times : 10 ],                            
    [ task : allServicePagesTask,  max_threads : 3, num_times : 10 ],                            
])
