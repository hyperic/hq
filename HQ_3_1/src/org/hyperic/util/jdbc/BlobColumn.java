...
/**
 * A common interface for BlobColumns which unfortunately
 * do not typically have much in common.
 */
public interface BlobColumn {
    ...
    public void setIdColName(String s); 
    public String getIdColName();
    public void setBlobColName(String s);
