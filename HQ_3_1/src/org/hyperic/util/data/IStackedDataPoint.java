...
/**
 * IStackedDataPoint is an interface that is used to allow the chart to retrieve
 * multiple values for per column in a stacked column chart. This interface
 * is a sub-interface of the IDisplayDataPoint interface. The getValue member
