...
public class FindAllPlatformTypesFetcher 
    extends GenericEJBFetcher
{
    private AppdefBoss boss;
    private int        authToken;

    public FindAllPlatformTypesFetcher(AppdefBoss boss, int authToken){
        this.boss      = boss;
    ...
    {
        try {
            return this.boss.findAllPlatformTypes(this.authToken, control);
        } catch(Exception exc){
