...
public class FindAIJobFetcher extends GenericEJBFetcher {

    private AppdefEntityID id;
    private AIBoss         boss;
    private int            authToken;

    public FindAIJobFetcher(AIBoss boss, int authToken,
                            AppdefEntityID id){
        this.boss      = boss;
    ...
    {
        try {
            return this.boss.findJobHistory(this.authToken, this.id, pc);
        } catch(Exception exc){
