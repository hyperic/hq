...
public class FindAllServerTypesFetcher 
    extends GenericEJBFetcher
{
    private AppdefBoss boss;
    private int        authToken;

    public FindAllServerTypesFetcher(AppdefBoss boss, int authToken){
        this.boss      = boss;
    ...
    {
        try {
            return this.boss.findAllServerTypes(this.authToken, control);
        } catch(Exception exc){
