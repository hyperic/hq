...
public class FindAllPlatformsFetcher 
    extends GenericEJBFetcher
{
    private AppdefBoss boss;
    private int        authToken;

    public FindAllPlatformsFetcher(AppdefBoss boss, int authToken){
        this.boss      = boss;
    ...
    {
        try {
            return this.boss.findAllPlatforms(this.authToken, control);
        } catch(Exception exc){
