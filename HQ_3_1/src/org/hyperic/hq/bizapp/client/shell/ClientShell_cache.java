...
public class ClientShell_cache extends MultiwordShellCommand {

    private ClientShell shell;

    public ClientShell_cache(ClientShell shell){
        this.shell = shell;
    }
        ...
        throws ShellCommandInitException 
    {
        ...
        handler = new ClientShell_cache_clear(this.shell);
        registerSubHandler("clear", handler);
    }

    public String getUsageShort(){
        return "Manipulate HQ caches";
    }
}
