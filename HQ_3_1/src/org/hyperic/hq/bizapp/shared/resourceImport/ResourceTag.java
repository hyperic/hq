...
{
    XmlResourceValue ownerEnt;

    protected void setEntityVal(XmlResourceValue ownerEnt){
        this.ownerEnt = ownerEnt;
    }

    public XmlTagInfo[] getSubTags(){
        return new XmlTagInfo[] {
            new XmlTagInfo(new ControlConfigTag(this.ownerEnt),
                                XmlTagInfo.OPTIONAL),
            new XmlTagInfo(new MetricTag(this.ownerEnt),
                                XmlTagInfo.OPTIONAL),
            new XmlTagInfo(new ResourceConfigTag(this.ownerEnt),
                                XmlTagInfo.OPTIONAL),
            new XmlTagInfo(new CustomPropsTag(this.ownerEnt),
                                XmlTagInfo.OPTIONAL),
        };
    }
}
