...
public class Event extends PersistedObject {
    ...
    private long       _ctime;
    private Collection _triggerEvents;
    ...
    public Collection getTriggerEvents() {
        return Collections.unmodifiableCollection(_triggerEvents);
    }
    
    protected Collection getTriggerEventsBag() {
        return _triggerEvents;
    }
    
    protected void setTriggerEventsBag(Collection triggerEvents) {
