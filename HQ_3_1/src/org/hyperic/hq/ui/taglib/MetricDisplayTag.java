 ...
 * 
 * Suppose you have a metricDisplaySummary.setMin(9234289)
 * and metricDisplaySummary.setUnit("bytes") set in the bean, this
 * tag allows you to say:
 * 
 ...
 * <span>9,018 KB</span>
 * 
 * This class assumes that any re-scaling of the metric value and unit
 * string as well as any localization of the unit string was performed
 * prior to the data being parameterized for this tag.  To assure that
 * the locale of the unit string agrees with the locale of the metric,
 * use the jakarta-struts key org.apache.struts.Globals.LOCALE_KEY
 */
public class MetricDisplayTag extends TagSupport {
    ...
    public int doEndTag() throws JspException {
        ...
        if (defaultKeyIsSet) {
            setDefaultKeyVal((String)evalAttr("defaultKey", defaultKey_el,
                                              String.class));
        }
        ...
        // and the UnitsConvert/UnitsFormat stuff
            ...
            FormattedNumber f =
                UnitsConvert.convert(getMetricVal().doubleValue(),
                                     getUnitVal(), userLocale);
