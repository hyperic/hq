...
/**
 * This action prepares the portal for configuring 
 * group monitoring.
 */
public class ConfigPortalAction extends ResourceConfigPortalAction {

    private static final String CONFIG_METRICS_PORTAL
        = ".resource.group.monitor.config.ConfigMetrics";
    private static final String CONFIG_METRICS_TITLE
        = "resource.group.monitor.visibility.config.ConfigureVisibility.Title";
 
    private static final String ADD_METRICS_PORTAL
        = ".resource.group.monitor.config.AddMetrics";
    private static final String ADD_METRICS_TITLE
        = "resource.group.monitor.visibility.config.AddMetrics.Title";

    private static final String EDIT_AVAILABILITY_PORTAL
        = ".resource.group.monitor.config.EditAvailability";
    private static final String EDIT_AVAILABILITY_TITLE
        = "resource.group.monitor.visibility.config.ConfigureVisibility.EditGroupAvail.Title";
    ...
    /** mode=addMetrics */
    public ActionForward addMetrics(ActionMapping mapping,
                                    ActionForm form,
                                    HttpServletRequest request,
                                    HttpServletResponse response)
        throws Exception {
