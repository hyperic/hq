 ...
 *
 */
public class AIScheduleValue
   extends org.hyperic.hq.autoinventory.AIScheduleBaseValue
   implements java.io.Serializable
{
   ...
   public AIScheduleValue( AIScheduleValue otherValue )
   {
   ...
   public String toString()
   {
	  ...
	  str.append("id=" + getId() + " " + "entityType=" + getEntityType() + " " + "entityId=" + getEntityId() + " " + "subject=" + getSubject() + " " + "scheduleValue=" + getScheduleValue() + " " + "scheduleValueBytes=" + getScheduleValueBytes() + " " + "triggerName=" + getTriggerName() + " " + "jobName=" + getJobName() + " " + "nextFireTime=" + getNextFireTime() + " " + "jobOrderData=" + getJobOrderData() + " " + "scanName=" + getScanName() + " " + "scanDesc=" + getScanDesc());
	  str.append('}');
   ...
   public boolean equals(Object other)
   {
	  ...
	  if (other instanceof AIScheduleValue)
	  {
		 AIScheduleValue that = (AIScheduleValue) other;
