   ...
   implements java.io.Serializable
{
   ...
   public String toString()
   {
	  ...
	  str.append("name=" + getName() + " " + "sortName=" + getSortName() + " " + "description=" + getDescription() + " " + "plugin=" + getPlugin() + " " + "isInternal=" + getIsInternal() + " " + "id=" + getId() + " " + "mTime=" + getMTime() + " " + "cTime=" + getCTime());
	  str.append('}');
