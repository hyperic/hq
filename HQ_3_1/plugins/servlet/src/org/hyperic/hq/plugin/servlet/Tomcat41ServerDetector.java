...
public class Tomcat41ServerDetector 
    extends Tomcat40ServerDetector
    implements FileServerDetector,
               RegistryServerDetector {

    static final String UNIQUE_JAR = "tomcat-warp.jar";
    
    private Log log = LogFactory.getLog("Tomcat41ServerDetector");

    public Tomcat41ServerDetector () { 
        super();
    ...
    {
        return new Tomcat41RuntimeADPlugin();
    }

    public List getRegistryScanKeys() {
        ArrayList keys = new ArrayList();
        keys.add("SOFTWARE\\Apache Group\\Tomcat\\4.1");
        return keys;
    }
}
