...
/**
 * Utility class for ServerRestartHandler.
 */
public class ServerRestartHandlerUtil
{
  ...
  private static final java.lang.String CONNECTION_FACTORY_JNDI_NAME="";
    ...
    * @return Destination JMS Queue for ServerRestartHandler. Lookup using JNDI_NAME
    */
   ...
   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Connection Factory for ServerRestartHandler. Lookup using JNDI_NAME
    */
