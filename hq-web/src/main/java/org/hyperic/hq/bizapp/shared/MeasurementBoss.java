...
public interface MeasurementBoss
{
    ...
    */
   public org.hyperic.hq.appdef.shared.AppdefEntityID[] getAutoGroupMemberIDs( AuthzSubject subject,org.hyperic.hq.appdef.shared.AppdefEntityID[] aids,AppdefEntityTypeID ctype ) throws org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Update the default interval for a list of template ids
    */
   public void updateMetricDefaultInterval( int sessionId,java.lang.Integer[] tids,long interval ) throws org.hyperic.hq.auth.shared.SessionException;

   /**
    * Update the templates to be indicators or not
    */
   public void updateIndicatorMetrics( int sessionId,AppdefEntityTypeID aetid,java.lang.Integer[] tids ) throws org.hyperic.hq.measurement.TemplateNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException;

   public List findMeasurementTemplates( int sessionId,AppdefEntityTypeID typeId,String category,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException;

   public List findMeasurementTemplates( int sessionId,AppdefEntityID aeid ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    */
   public List findMeasurementTemplates( int sessionId,String mtype,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException;

   /**
    * Retrieve list of measurement templates given specific IDs
    */
   public List findMeasurementTemplates( String user,java.lang.Integer[] ids,PageControl pc ) throws javax.security.auth.login.LoginException, org.hyperic.hq.common.ApplicationException, org.hyperic.util.ConfigPropertyException;

   /**
    * Retrieve list of measurement templates given specific IDs
    * @return a List of MeasurementTemplateValue objects
    */
   public List findMeasurementTemplates( int sessionId,java.lang.Integer[] ids,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.measurement.TemplateNotFoundException;

   /**
    * Retrieve a measurement template given specific ID
    */
   public MeasurementTemplate getMeasurementTemplate( int sessionId,Integer id ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.measurement.TemplateNotFoundException;

   /**
    * Get the the availability metric template for the given autogroup
    * @return The availabililty metric template.
    */
   public MeasurementTemplate getAvailabilityMetricTemplate( int sessionId,AppdefEntityID aid,AppdefEntityTypeID ctype ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.measurement.MeasurementNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Get the the availability metric template for the given resource
    * @return template of availabililty metric
    */
   public MeasurementTemplate getAvailabilityMetricTemplate( int sessionId,AppdefEntityID aeid ) throws org.hyperic.hq.measurement.MeasurementNotFoundException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    */
   public void disableMeasurements( int sessionId,AppdefEntityID id ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    */
   public void disableMeasurements( int sessionId,AppdefEntityID id,java.lang.Integer[] tids ) throws org.hyperic.hq.auth.shared.SessionException, javax.ejb.RemoveException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.grouping.shared.GroupNotCompatibleException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Disable all measurements for a resource
    * @param tids the array of measurement ID's
    */
   public void disableAGMeasurements( int sessionId,AppdefEntityID parentId,AppdefEntityTypeID childType,java.lang.Integer[] tids ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, javax.ejb.RemoveException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.grouping.shared.GroupNotCompatibleException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Find a measurement using measurement id
    * @param id measurement id
    */
   public Measurement getMeasurement( int sessionID,Integer id ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.measurement.MeasurementNotFoundException;

   /**
    * Get the last metric values for the given template IDs.
    * @param tids The template IDs to get
    */
   public org.hyperic.hq.product.MetricValue[] getLastMetricValue( int sessionId,AppdefEntityID aeid,java.lang.Integer[] tids ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    */
   public Measurement findMeasurement( int sessionId,Integer tid,AppdefEntityID id ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.measurement.MeasurementNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException;

   /**
    * Retrieve List of measurements for a specific instance
    * @return List of Measurement objects
    */
   public List findMeasurements( int sessionId,AppdefEntityID id,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.grouping.shared.GroupNotCompatibleException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    */
   public List findMeasurements( int sessionId,Integer tid,org.hyperic.hq.appdef.shared.AppdefEntityID[] entIds ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.measurement.MeasurementNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    */
   public List findEnabledAGMeasurements( int sessionId,AppdefEntityID parentId,AppdefEntityTypeID childType,String cat,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.grouping.shared.GroupNotCompatibleException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Retrieve list of measurements for a specific instance and category
    * @return a PageList of Measurement objects
    */
   public PageList findEnabledMeasurements( int sessionId,AppdefEntityID id,String cat,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.grouping.shared.GroupNotCompatibleException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    * @return a PageList of MetricValue objects
    */
   public PageList findMeasurementData( int sessionId,Integer tid,AppdefEntityID aid,long begin,long end,long interval,boolean returnNulls,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.measurement.MeasurementNotFoundException;
...
PermissionException;
    ...
    * @return a PageList of MetricValue objects
    */
   public PageList findMeasurementData( String user,AppdefEntityID aid,MeasurementTemplate tmpl,long begin,long end,long interval,boolean returnNulls,PageControl pc ) throws javax.security.auth.login.LoginException, org.hyperic.hq.common.ApplicationException, org.hyperic.util.ConfigPropertyException;
    ...
    * @return a PageList of MetricValue objects
    */
   public PageList findMeasurementData( int sessionId,AppdefEntityID aid,MeasurementTemplate tmpl,long begin,long end,long interval,boolean returnNulls,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.measurement.MeasurementNotFoundException;
    ...
    */
   public PageList findAGMeasurementData( String user,org.hyperic.hq.appdef.shared.AppdefEntityID[] aids,MeasurementTemplate tmpl,AppdefEntityTypeID ctype,long begin,long end,long interval,boolean returnNulls,PageControl pc ) throws javax.security.auth.login.LoginException, org.hyperic.hq.common.ApplicationException, org.hyperic.util.ConfigPropertyException;
    ...
    * @return a PageList of MetricValue objects
    */
   public PageList findAGMeasurementData( int sessionId,org.hyperic.hq.appdef.shared.AppdefEntityID[] aids,MeasurementTemplate tmpl,AppdefEntityTypeID ctype,long begin,long end,long interval,boolean returnNulls,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.measurement.MeasurementNotFoundException;

   /**
    * Returns metadata for particular measurement
    */
   public List findMetricMetadata( int sessionId,AppdefEntityID aid,AppdefEntityTypeID ctype,Integer tid ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.grouping.shared.GroupNotCompatibleException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.appdef.shared.ApplicationNotFoundException, org.hyperic.hq.measurement.TemplateNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
...
throws SessionTimeoutException, SessionNotFoundException,
 ...
 AppdefEntityNotFoundException, AppdefCompatException;
    ...
    */
   public MetricDisplaySummary findMetric( int sessionId,AppdefEntityID aeid,AppdefEntityTypeID ctype,Integer tid,long begin,long end ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.appdef.shared.AppdefCompatException, org.hyperic.hq.measurement.MeasurementNotFoundException;
    ...
    * @see org.hyperic.hq.bizapp.shared.uibeans.MetricDisplaySummary
    */
   public MetricDisplaySummary findMetric( int sessionId,List resources,Integer tid,long begin,long end ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.appdef.shared.AppdefCompatException, org.hyperic.hq.measurement.MeasurementNotFoundException;
    ...
    */
   public org.hyperic.hq.appdef.shared.AppdefResourceValue[] pruneResourcesNotCollecting( int sessionId,org.hyperic.hq.appdef.shared.AppdefResourceValue[] resources,Integer tid ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.measurement.MeasurementNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    */
   public Map findResourceMetricSummary( int sessionId,org.hyperic.hq.appdef.shared.AppdefEntityID[] entIds,long begin,long end ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.measurement.MeasurementNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    * @see org.hyperic.hq.bizapp.shared.uibeans.MetricDisplaySummary
    */
   public Map<String,Set<MetricDisplaySummary>> findMetrics( int sessionId,AppdefEntityID entId,java.util.List<Integer> mtids,long begin,long end ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.appdef.shared.AppdefCompatException;
    ...
    * @throws AppdefCompatException
    */
   public Map findAGPlatformMetricsByType( int sessionId,AppdefEntityTypeID platTypeId,long begin,long end,boolean showAll ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.InvalidAppdefTypeException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefCompatException;
    ...
    * @throws AppdefCompatException
    */
   public Map findAGMetricsByType( int sessionId,org.hyperic.hq.appdef.shared.AppdefEntityID[] entIds,AppdefEntityTypeID typeId,long filters,String keyword,long begin,long end,boolean showAll ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.InvalidAppdefTypeException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.appdef.shared.AppdefCompatException;
    ...
    */
   public MeasurementSummary getSummarizedResourceAvailability( int sessionId,AppdefEntityID entId,int appdefType,Integer typeId ) throws org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.util.config.InvalidOptionException;
    ...
    */
   public List findSummarizedServerCurrentHealth( int sessionId,AppdefEntityID entId ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    */
   public List findSummarizedPlatformServiceCurrentHealth( int sessionId,AppdefEntityID entId ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException;

   public List findSummarizedServiceCurrentHealth( int sessionId,AppdefEntityID entId ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException;
    ...
    */
   public List findGroupCurrentHealth( int sessionId,Integer id ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    * @return List of ResourceDisplaySummary beans
    */
   public List findVirtualsCurrentHealth( int sessionId,AppdefEntityID entId ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.grouping.shared.GroupNotCompatibleException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    */
   public List findResourcesCurrentHealth( String user,org.hyperic.hq.appdef.shared.AppdefEntityID[] entIds ) throws javax.security.auth.login.LoginException, org.hyperic.hq.common.ApplicationException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException;
    ...
    * @return PageList of ResourceDisplaySummary beans
    */
   public List findResourcesCurrentHealth( int sessionId,org.hyperic.hq.appdef.shared.AppdefEntityID[] entIds ) throws org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException;

   /**
    * Find the current health of the entity's host(s)
    * @return PageList of ResourceDisplaySummary beans
    */
   public List findHostsCurrentHealth( int sessionId,AppdefEntityID entId,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException;
    ...
    * @return PageList of ResourceDisplaySummary beans
    */
   public PageList findPlatformsCurrentHealth( int sessionId,AppdefEntityID entId,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    */
   public List findAGPlatformsCurrentHealthByType( int sessionId,Integer platTypeId ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.InvalidAppdefTypeException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException;
    ...
    * @return a list of ResourceDisplaySummary beans
    */
   public PageList findServersCurrentHealth( int sessionId,AppdefEntityID entId,PageControl pc ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.InvalidAppdefTypeException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    * @return a list of ResourceDisplaySummary beans
    */
   public List findAGServersCurrentHealthByType( int sessionId,org.hyperic.hq.appdef.shared.AppdefEntityID[] entIds,Integer serverTypeId ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.InvalidAppdefTypeException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    * @return a list of ResourceDisplaySummary beans
    */
   public List findAGServicesCurrentHealthByType( int sessionId,org.hyperic.hq.appdef.shared.AppdefEntityID[] entIds,Integer serviceTypeId ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.InvalidAppdefTypeException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Get Availability measurement for a given entitiy
    */
   public double getAvailability( AuthzSubject subj,AppdefEntityID id ) throws org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Get the availability of the resource
    * @param id the Appdef entity ID
    */
   public double getAvailability( int sessionId,AppdefEntityID id ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;

   /**
    * Get the availability of autogroup resources
    * @return a MetricValue for the availability
    */
   public double getAGAvailability( int sessionId,org.hyperic.hq.appdef.shared.AppdefEntityID[] aids,AppdefEntityTypeID ctype ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException;
    ...
    * @throws AppdefCompatException
    */
   public List findAllMetrics( int sessionId,AppdefEntityID aeid,AppdefEntityTypeID ctype,long begin,long end ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefCompatException, org.hyperic.hq.appdef.shared.InvalidAppdefTypeException;
    ...
    */
   public List findAllMetrics( int sessionId,AppdefEntityID aeid,org.hyperic.hq.appdef.shared.AppdefEntityID[] hosts,org.hyperic.hq.appdef.shared.AppdefEntityTypeID[] children,org.hyperic.hq.appdef.shared.AppdefEntityID[] members,long begin,long end ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefCompatException, org.hyperic.hq.appdef.shared.InvalidAppdefTypeException;

   /**
    * Returns a list of problem metrics for a resource, and the selected children and hosts of that resource. Return a summarized list of UI beans
    */
   public List findAllMetrics( int sessionId,AppdefEntityID aeid,org.hyperic.hq.appdef.shared.AppdefEntityID[] hosts,org.hyperic.hq.appdef.shared.AppdefEntityTypeID[] children,long begin,long end ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException, org.hyperic.hq.appdef.shared.AppdefEntityNotFoundException, org.hyperic.hq.authz.shared.PermissionException, org.hyperic.hq.appdef.shared.AppdefCompatException, org.hyperic.hq.appdef.shared.InvalidAppdefTypeException;

   /**
    * Get the availability metric for a given resource
    */
   public Measurement findAvailabilityMetric( int sessionId,AppdefEntityID id ) throws org.hyperic.hq.auth.shared.SessionTimeoutException, org.hyperic.hq.auth.shared.SessionNotFoundException;
