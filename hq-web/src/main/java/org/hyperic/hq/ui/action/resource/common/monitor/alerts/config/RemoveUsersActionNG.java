 ...
 * 
 */
@Component("alertsRemoveUsersActionNG")
@Scope("prototype")
public class RemoveUsersActionNG extends RemoveNotificationsActionNG {
	private final Log log = LogFactory.getLog(RemoveUsersActionNG.class
			.getName());
