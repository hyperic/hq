...
import org.hyperic.hq.ui.action.resource.common.monitor.visibility.ResourceMetricsFormPrepareActionNG;
 ...
 */
@Component("groupMetricsFormPrepareActionNG")
public class GroupMetricsFormPrepareActionNG extends
		ResourceMetricsFormPrepareActionNG {
	...
	protected Map<String, Set<MetricDisplaySummary>> getMetrics(
			HttpServletRequest request, long filters, String keyword,
			AppdefEntityID entityId, Long begin, Long end, boolean showAll)
			throws Exception {
