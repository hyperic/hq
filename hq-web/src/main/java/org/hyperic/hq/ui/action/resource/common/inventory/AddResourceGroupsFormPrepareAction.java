 ...
 * display of the various pages to add group memeberships for resources.
 */
public class AddResourceGroupsFormPrepareAction
    extends Action {

    private final Log log = LogFactory.getLog(AddResourceGroupsFormPrepareAction.class.getName());
     ...
     * <li><code>List</code> of pending <code>ResourceGroupValue</code> objects
