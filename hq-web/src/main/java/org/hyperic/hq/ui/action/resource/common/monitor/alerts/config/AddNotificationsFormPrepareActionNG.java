 ...
 * 
 */
public abstract class AddNotificationsFormPrepareActionNG
    extends BaseActionNG {
    protected final Log log = LogFactory.getLog(AddNotificationsFormPrepareActionNG.class.getName());
     ...
     */
    public Integer[] getNotificationIds(HttpServletRequest request, AddNotificationsFormNG addForm, AppdefEntityID aeid,
