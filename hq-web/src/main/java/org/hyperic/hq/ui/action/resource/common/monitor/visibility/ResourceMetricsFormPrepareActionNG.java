 ...
 * metrcs pages.
 */
@Component("platformResourceMetricsFormPrepareActionNG")
public class ResourceMetricsFormPrepareActionNG extends
		MetricsDisplayFormPrepareActionNG {

	protected final Log log = LogFactory
			.getLog(ResourceMetricsFormPrepareActionNG.class.getName());
	...
	protected Map<String, Set<MetricDisplaySummary>> getMetrics(
		...
		Map<String, Set<MetricDisplaySummary>> metrics = measurementBoss
				.findMetrics(sessionId, entIds, filters, keyword,
