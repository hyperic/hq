...
/**
 * This action prepares the portal for configuring the application monitoring
 * pages.
 */
public class ConfigPortalAction
    extends ResourceConfigPortalAction {

    private static final String CONFIG_METRICS_PORTAL = ".resource.application.monitor.config.ConfigMetrics";
    private static final String CONFIG_METRICS_TITLE = "resource.application.monitor.visibility.config.ConfigureVisibility.Title";

    private static final String ADD_METRICS_PORTAL = ".resource.application.monitor.config.AddMetrics";
    private static final String ADD_METRICS_TITLE = "resource.application.monitor.visibility.config.AddMetrics.Title";
