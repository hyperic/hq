 ...
 *
 */
public abstract class ResourceConfigPortalActionNG extends ResourceControllerNG {

	
	public String configMetrics() throws Exception {

		super.setNavMapLocation(Constants.MONITOR_CONFIG_LOC);

		return ConstantsNG.MONITOR_CONFIG_LOC;
