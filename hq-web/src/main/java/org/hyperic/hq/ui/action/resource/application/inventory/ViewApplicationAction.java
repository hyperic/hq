 ...
 */
public class ViewApplicationAction
    extends TilesAction {
    ...
    public ActionForward execute(ComponentContext context, ActionMapping mapping, ActionForm form,
        ...
        // count tile
        request.setAttribute(Constants.NUM_CHILD_RESOURCES_ATTR, new Integer(services.getTotalSize()));
        ...
        PageList<AppdefGroupValue> groups = appdefBoss.findAllGroupsMemberInclusive(sessionId.intValue(), pcg, app
            .getEntityId());
        ...
        List<ServiceTypeValue> serviceTypes = appdefBoss
            .findAllServiceTypes(sessionId.intValue(), PageControl.PAGE_ALL);
        ...
        request.setAttribute(Constants.RESOURCE_REMOVE_APPSERVICES_FORM_ATTR, removeAppServicesForm);
