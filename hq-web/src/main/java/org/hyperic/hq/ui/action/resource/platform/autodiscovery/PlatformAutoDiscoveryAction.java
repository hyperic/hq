...
public class PlatformAutoDiscoveryAction
    ...
    public ActionForward newAutoDiscovery(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        Portal portal = Portal.createPortal(TITLE_PATH + "NewPlatformAutodiscoveryTitle",
    ...
    public ActionForward viewResults(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        if (mapping instanceof BaseActionMapping) {
            ...
            if (workflow != null) {
                SessionUtils.pushWorkflow(request.getSession(), mapping, workflow);
            }
        }
    ...
    private void findAndSetAISchedule(HttpServletRequest request) throws Exception {
     ...
     */
    private void loadScanState(HttpServletRequest request, PlatformValue pVal) throws ServletException,
        SessionTimeoutException, SessionNotFoundException, PermissionException, AgentRemoteException,
        AutoinventoryException, RemoteException {
        ...
        try {
            aip = aiBoss.findAIPlatformByPlatformID(sessionId, pVal.getId().intValue());
    ...
    public void loadAIResource(HttpServletRequest request) throws Exception {
        ...
        Integer id = RequestUtils.getIntParameter(request, Constants.AI_PLATFORM_PARAM);
        AIPlatformValue aip = aiBoss.findAIPlatformById(sessionId, id.intValue());
