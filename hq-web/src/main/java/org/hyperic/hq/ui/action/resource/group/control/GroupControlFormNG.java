 ...
 */
public class GroupControlFormNG  extends ControlFormNG {
    ...
    private Map<String, String> resourceOrderingOptions;

    // -------------------------------------constructors

    public GroupControlFormNG() {
    }
...
//    }
     ...
     * 
     */
    public Map<String, String> getResourceOrderingOptions() {
        return this.resourceOrderingOptions;
    }

    /**
     * Setter for property resourceOrderingOptions.
     * @param groupOptions New value of property
     *        resourceOrderingOptions.
     * 
     */
    public void setResourceOrderingOptions(Map<String, String> groupOptions) {
        this.resourceOrderingOptions = groupOptions;
    }
