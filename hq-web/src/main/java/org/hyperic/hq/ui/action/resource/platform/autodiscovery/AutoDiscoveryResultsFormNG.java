...
public class AutoDiscoveryResultsFormNG extends RemoveResourceFormNG {
    ...
    private HashMap<String,String> serverTypeFilterList = null;

    /**
     * 
     */
    public AutoDiscoveryResultsFormNG() {
        super();
    }
     ...
     * @return
     */
    public HashMap<String,String> getServerTypeFilterList() {
    ...
    public void setServerTypeFilterList(AppdefResourceTypeValue[] serverTypes) {
        ...
        serverTypeFilterList = new HashMap<String,String>();
        // CollectionUtils.addAll(serverTypeFilterList, serverTypes);
        for (AppdefResourceTypeValue serverType : serverTypes) {
        	serverTypeFilterList.put( serverType.getId().toString(), serverType.getName());
        }
    }
}
