...
public class BizappUtilsNG {

    private static Log log = LogFactory.getLog(BizappUtilsNG.class.getName());
    ...
    public static AppdefResourceTypeValue[] buildSupportedAIServerTypes
        ...
        List filteredServerTypes = BizappUtilsNG.
    ...
    public static List sortAIResource(List resource)
    {
        List sortedList = new ArrayList();
        SortedSet sSet =
            new TreeSet(new BizappUtilsNG().new AIResourceIdComparator());
                                                     ...
                                                     Iterator<ServerSignature> sigIterator) 
    {
        ...
        synchronized(serverTypes) {
            while (sigIterator.hasNext()) {
                ...
                AppdefResourceTypeValue stype = 
                        BizappUtilsNG.findResourceTypeValue(sTypes, st.getServerTypeName());
    ...
    public static List<AppdefResourceValue> sortAppdefResource(List appdefList, PageControl pc) 
    {
        List sortedList = new ArrayList();
        SortedSet sSet =
            new TreeSet(new BizappUtilsNG().new AppdefResourceNameComparator(pc));
