 ...
 * 
 */
@Component("viewDefinitionNotificationsUsersActionNG")
@Scope("prototype")
public class ViewDefinitionNotificationsUsersActionNG extends
		ViewDefinitionNotificationsActionNG {
	private static final String[] SORT_ATTRS = { "name", "lastName",
			"firstName" };

	private final Log log = LogFactory
			.getLog(ViewDefinitionNotificationsUsersActionNG.class.getName());

	public int getNotificationType() {
		return EmailActionConfig.TYPE_USERS;
	}

	protected PageList getPageList(int sessionID, EmailActionConfig ea,
		...
		int sortOrder = pc.isAscending() ? JavaBeanPropertyComparator.ASCENDING
				: JavaBeanPropertyComparator.DESCENDING;
		JavaBeanPropertyComparator c = new JavaBeanPropertyComparator(
				SORT_ATTRS[pc.getSortattribute()], sortOrder);
