 ...
 */
public class QuickControlFormNG
    ...
    private Map<String, String> controlActions;
     ...
     * 
     */
    public Map<String, String> getControlActions() {
     ...
     * 
     */
    public void setControlActions(Map<String, String> controlActions) {
