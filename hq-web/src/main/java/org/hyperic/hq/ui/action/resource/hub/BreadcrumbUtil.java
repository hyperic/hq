...
public class BreadcrumbUtil {
	public static String createRootBrowseURL(String baseUrl,
			ResourceHubFormNG hubForm, PageControl pageControl) {
	...
	public static String createRootBrowseURL(String baseUrl, int entityTypeId,
			Integer groupTypeId) {
		StringBuilder url = new StringBuilder(baseUrl);
	...
	public static String createResourceURL(String baseUrl, String entityId,
			String ctype) {
		StringBuilder url = new StringBuilder(baseUrl);

		url.append("?");
		url.append(Constants.ENTITY_ID_PARAM).append("=")
				.append(encode(entityId));

		if (ctype != null && !ctype.equals("")) {
			url.append("&").append(Constants.CHILD_RESOURCE_TYPE_ID_PARAM)
					.append("=").append(encode(ctype));
		}
	...
	public static String createReturnToURL(String baseUrl) {
		...
		url.append(Constants.RETURN_TO_LINK_PARAM_NAME).append("=")
				.append(Constants.RETURN_TO_LINK_PARAM_VALUE);
