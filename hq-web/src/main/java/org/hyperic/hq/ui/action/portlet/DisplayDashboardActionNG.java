...
@Component("displayDashboardActionNG")
@Scope(value = "prototype")
public class DisplayDashboardActionNG extends BaseActionNG implements ModelDriven<DashboardFormNG>{
	...
	public String execute() throws Exception {
	       HttpSession session = request.getSession();
	        ...
	        if (dashPrefs.getValue(Constants.USER_PORTLETS_FIRST_NG) == null &&
	            dashPrefs.getValue(Constants.USER_PORTLETS_SECOND_NG) == null) {
	        	...
	        	ConfigResponse defaultRoleDashPrefs = (ConfigResponse) context.getAttribute(Constants.DEF_ROLE_DASH_PREFS);
	        ...
	        portal.addPortletsFromString(dashPrefs.getValue(Constants.USER_PORTLETS_FIRST_NG), 1);
	        portal.addPortletsFromString(dashPrefs.getValue(Constants.USER_PORTLETS_SECOND_NG), 2);
