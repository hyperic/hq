...
<form method="POST" action="<s:url value='/app/dashboard/%{#attr.selectedDashboardId}/portlets' />" onsubmit="return isDivAddContents<c:out value='${wide}' />PortletValid()">
	<s:hidden theme="simple"  name="wide" value="%{#attr.wide}"/>
  	<table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr valign="top">
      <td colspan="3" class="ToolbarLine"><img src='<s:url  value="/images/spacer.gif"/>' width="20" height="1" border="0" /></td>
    </tr>
    <tr valign="top">
      <td colspan="3"><img src='<s:url  value="/images/spacer.gif"/>' width="20" height="1" border="0" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td width="100%"><input type="image" name="ok" src='<s:url value="/images/4.0/icons/add.png" />' border="0" title="<fmt:message key='FormButtons.ClickToOk' />" /></td>
    </tr>
  </table>
</form>
</div>
