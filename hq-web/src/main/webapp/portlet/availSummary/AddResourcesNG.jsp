...
<tiles:insertDefinition name=".page.title">
  <tiles:putAttribute name="titleKey" value="dash.settings.availsummary.AddResourcesPageTitle"/>
...
<tiles:insertDefinition name=".form.buttons">
  ...
  <tiles:putAttribute name="cancelAction"  value="cancelAvailSummaryModifyAddResourcesPortlet" />
  <tiles:putAttribute name="resetAction"   value="resetAvailSummaryModifyAddResourcesPortlet" />
  <tiles:putAttribute name="addedAction"   value="addASResourcesHandlePortlet" />
</tiles:insertDefinition>
