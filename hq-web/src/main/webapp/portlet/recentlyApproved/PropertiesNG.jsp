      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <table width="100%" cellpadding="0" cellspacing="5" border="0">
             <tr>
              ...
              <td>
                 ...
                 <s:select name="range" theme="simple" cssStyle="FilterFormText"  disabled="%{!#attr.modifyDashboard}" list="#{'1':'1','5':'5','10':'10','20':'20'}" value="%{#attr.range}"	 />
       ...
       <tiles:insertDefinition name=".form.buttons">
		  <c:if test='${sessionScope.modifyDashboard}'>
			<tiles:putAttribute name="cancelAction"  value="cancelRecentlyApprovedModifyPortlet" />
			<tiles:putAttribute name="resetAction"  value="resetRecentlyApprovedModifyPortlet" />
		  </c:if>
      </tiles:insertDefinition>
