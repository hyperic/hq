...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="TableBottomLine">
    			...
    			<tr>
     				...
     				<logic:messagesNotPresent property="firstName">
      				...
      				<logic:messagesPresent property="lastName">
        				<td class="ErrorField" style="padding-left: 5px;">
					...
					<logic:messagesNotPresent property="lastName">
						<td style="padding-left: 5px;"><html:text size="${textBoxSize}" maxlength="50" property="lastName" tabindex="2"/></td>
					</logic:messagesNotPresent>
      			</tr>
      		</table>
    	</td>
    ...
    <tr>
     	...
     	<logic:messagesPresent property="phoneNumber">
      		<td width="30%" class="ErrorField">
      			<html:text size="31" maxlength="50" property="phoneNumber" tabindex="9"/>
      			<br/>
    ...
    <tr>
      	...
      	<td class="BlockContent" valign="top">
      		<html:text size="31" maxlength="50" property="department" tabindex="10"/>
      	</td>
	</tr>	 
    <tr>
     	<td class="BlockLabel">
      	...
      	<logic:messagesPresent property="emailAddress">
        	<td class="ErrorField">
         		<html:text size="31" property="emailAddress" tabindex="5"/>
         		<br/>
