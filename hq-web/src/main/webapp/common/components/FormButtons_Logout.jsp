    ...
    <td width="80%">
      <table width="100%" cellpadding="0" cellspacing="7" border="0">
        <tr>
          ...
          <td nowrap><html:link action="/Logout"><fmt:message key="admin.user.generalProperties.Logout"/></html:link> <fmt:message key="admin.user.generalProperties.CompleteLater"/></td>
