...
<s:form action="loadAssignNewPlatformOwner">
...
<tiles:insertDefinition name=".ng.resource.common.inventory.changeResourceOwner">
  ...
  <tiles:putAttribute name="formName" value="loadAssignNewPlatformOwner"/>
...
<tiles:insertDefinition name=".form.buttons" >
	<tiles:putAttribute name="cancelAction"  value="cancelAssignNewPlatformOwner" />
