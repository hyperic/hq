...
<s:form method="POST" action="executeGroupResourcesToPlatforms">
...
<tiles:insertDefinition name=".form.buttons">
  ...
  <tiles:putAttribute name="cancelAction"  value="cancelGroupResourcesToPlatforms" />
  <tiles:putAttribute name="resetAction"   value="resetGroupResourcesToPlatforms" />
  <tiles:putAttribute name="addedAction"   value="executeGroupResourcesToPlatforms" />
</tiles:insertDefinition>
