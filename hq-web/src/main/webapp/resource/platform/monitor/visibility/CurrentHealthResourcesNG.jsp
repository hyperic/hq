...
<table width="285" cellpadding="2" cellspacing="0" border="0">
  <tr>
    <td>
      <tiles:insertDefinition name=".resource.platform.monitor.visibility.listchildresources">
        <tiles:putAttribute name="mode" value="${mode}"/>
        <tiles:putAttribute name="internal" value="true"/>
        <tiles:putAttribute name="childResourceType" value="3"/>
        <tiles:putAttribute name="childResourcesHealthKey" value="resource.common.monitor.visibility.PlatformServicesHealthTab"/>
  ...
  <tr>
    <td>
      <tiles:insertDefinition name=".resource.platform.monitor.visibility.listchildresources">
        ...
        <tiles:putAttribute name="childResourceType" value="2"/>
        <tiles:putAttribute name="childResourcesHealthKey" value="resource.platform.monitor.visibility.DeployedServersHealthTab"/>
        <tiles:putAttribute name="childResourcesTypeKey" value="resource.platform.monitor.visibility.ServerTypeTH"/>
        <tiles:putAttribute name="checkboxes" value="${showProblems}"/>
      </tiles:insertDefinition>
    </td>
  </tr>
  <tr>
    <td>
      <tiles:insertDefinition name=".resource.common.monitor.visibility.listvirtualresources">
        ...
        <tiles:putAttribute name="childResourcesHealthKey" value="resource.common.monitor.visibility.VirtualPlatformsHealthTab"/>
        <tiles:putAttribute name="childResourcesTypeKey" value="resource.group.monitor.visibility.PlatformTypeTH"/>
        <tiles:putAttribute name="checkboxes" value="${showProblems}"/>
      </tiles:insertDefinition>
    </td>
  </tr>
