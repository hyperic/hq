...
<s:form action="loadAssignNewGroupOwner">
	...
	<tiles:insertDefinition name=".ng.resource.common.inventory.changeResourceOwner">
	  ...
	  <tiles:putAttribute name="formName" value="loadAssignNewGroupOwner"/>
	  <tiles:putAttribute name="selfUrl" value="${selfUrl}"/>
	</tiles:insertDefinition>
	&nbsp;<br/>

<tiles:insertDefinition name=".form.buttons" >
	<tiles:putAttribute name="cancelAction"  value="cancelAssignNewGroupOwner" />
