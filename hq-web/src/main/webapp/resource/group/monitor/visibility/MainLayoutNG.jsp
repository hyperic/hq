...
<c:choose>
    <c:when test="${ canControl }">
        <tiles:insertDefinition name=".tabs.resource.group.monitor.visibility">
          <tiles:putAttribute name="resourceId" value="${Resource.id}"/>
          <tiles:putAttribute name="resourceType" value="${entityId.type}"/>
        </tiles:insertDefinition>
    </c:when>
    <c:otherwise>
        <tiles:insertDefinition name=".tabs.resource.group.monitor.visibility.nocontrol">
          <tiles:putAttribute name="resourceId" value="${Resource.id}"/>
          <tiles:putAttribute name="resourceType" value="${entityId.type}"/>
        </tiles:insertDefinition>
    </c:otherwise>
  ...
  <tr>
    ...
    <c:choose>
      ...
      <c:when test="${isResourceMetrics}">
        <s:form action="/resource/group/monitor/visibility/FilterGroupMetrics">
          <input type="hidden" name="eid" value="<c:out value="${eid}"/>">
          <tiles:insertTemplate template="/resource/group/monitor/visibility/CurrentHealthResourcesNG.jsp">
            <tiles:putAttribute name="mode" value="${mode}"/>
    ...
    <c:choose>
      ...
      <c:when test="${isResourceMetrics}">
        <tiles:insertTemplate template="/resource/group/monitor/visibility/GroupMetricsNG.jsp">
