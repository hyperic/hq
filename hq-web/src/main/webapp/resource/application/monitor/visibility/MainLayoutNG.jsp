...
<tiles:insertDefinition name=".tabs.resource.application.monitor.visibility">
    ...
    <c:choose>
      <c:when test="${isCurrentHealth}">
        <s:form id="ProblemMetricsDisplayForm" name="ProblemMetricsDisplayForm" action="resourceAction">
          ...
          <tiles:insertTemplate template="/resource/application/monitor/visibility/CurrentHealthResourcesNG.jsp">
            <tiles:putAttribute name="mode" value="${mode}"/>
      ...
      <c:when test="${isResourceMetrics}">
        <s:form id="filterMetricsForm" name="filterMetricsForm" action="resourceMetricsMonitorApplicationVisibility.action">
          <input type="hidden" name="eid" value="<c:out value="${eid}"/>">
    ...
    <c:choose>
      <c:when test="${isCurrentHealth}">
        <tiles:insertTemplate template="/resource/common/monitor/visibility/IndicatorsNG.jsp">
          <tiles:putAttribute name="tabListName" value="nometrics"/>
          <tiles:putAttribute name="entityType" value="application"/>
        </tiles:insertTemplate>
      </c:when>
    </c:choose>
    </td>
