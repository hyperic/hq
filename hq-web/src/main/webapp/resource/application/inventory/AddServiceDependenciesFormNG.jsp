...
<tiles:insertDefinition name=".ng.toolbar.new">
	<tiles:putAttribute name="useFromSideBar" value="true"/>
	<tiles:putAttribute name="listItems" value="${availableServices}"/>
	<tiles:putAttribute name="listSize" value="${availableServicesCount}"/>
...
<tiles:insertDefinition name=".ng.toolbar.new">
  ...
  <tiles:putAttribute name="listItems" value="${pendingServices}"/>
  <tiles:putAttribute name="listSize" value="${pendingServicesCount}"/>
