		...
		<td class="LinkBox">
			<c:if test="${useroperations['createApplication']}">
				<html:link action="/resource/application/Inventory">
					...
					<fmt:message key="resource.hub.NewApplicationLink"/><html:img page="/images/title_arrow.gif" width="11" height="9" alt="" border="0"/>
				</html:link><br/>
			</c:if>
			...
			<c:if test="${useroperations['createPlatform']}">
			  	<html:link action="/resource/platform/Inventory">
			  		<html:param name="mode" value="new"/>
			  		<fmt:message key="resource.hub.NewPlatformLink"/><html:img page="/images/title_arrow.gif" width="11" height="9" alt="" border="0"/>
			  	</html:link><br/>
			</c:if>
		</td>
	</tr>
