...
<s:form action="saveEditServerGeneralProperties" >
...
<tiles:insertDefinition name=".form.buttons" >
	<tiles:putAttribute name="cancelAction"  value="cancelEditServerGeneralProperties" />
	<tiles:putAttribute name="resetAction"  value="resetEditServerGeneralProperties" />
</tiles:insertDefinition>
