...
<table width="285" cellpadding="2" cellspacing="0" border="0">
  <tr>
    <td>
<c:choose>
    <c:when test="${empty IsPlatformService}">
  ...
  <tr>
    <td>
      <tiles:insertDefinition name=".resource.common.monitor.visibility.listvirtualresources">
        ...
        <tiles:putAttribute name="childResourcesHealthKey" value="resource.common.monitor.visibility.VirtualServicesHealthTab"/>
        <tiles:putAttribute name="childResourcesTypeKey" value="resource.group.monitor.visibility.ServiceTypeTH"/>
        <tiles:putAttribute name="checkboxes" value="${showProblems}"/>
      </tiles:insertDefinition>
    </td>
  </tr>
