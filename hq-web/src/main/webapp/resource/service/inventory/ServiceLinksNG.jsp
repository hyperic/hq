...
<c:if test="${not empty resource}">
 <hq:userResourcePermissions debug="false" resource="${Resource}"/>
  <table border="0"><tr><td class="LinkBox">
	...
	<br />
	<s:a href="#" class="AddToGroupMenuLink"><fmt:message key="resource.group.AddToGroup.Title"/><img src='<s:url value="/images/title_arrow.gif"/>' width="11" height="9" alt="" border="0"/></s:a>
</td></tr></table>
