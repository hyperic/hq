...
<%--
  ...
  USA.
 --%>
<s:form method="POST" action="executeGroupResourcesToService.action">
...
<tiles:insertDefinition name=".ng.resource.common.inventory.addResourceGroups">
  ...
  <tiles:putAttribute name="resourceType" value="service"/>
</tiles:insertDefinition>

<tiles:insertDefinition name=".form.buttons">
  <tiles:putAttribute name="addToList" value="true"/>
  <tiles:putAttribute name="cancelAction"  value="cancelGroupResourcesToService" />
  <tiles:putAttribute name="resetAction"   value="resetGroupResourcesToService" />
  <tiles:putAttribute name="addedAction"   value="executeGroupResourcesToService" />
</tiles:insertDefinition>
