...
<s:form action="saveEditServiceGeneralProperties" >
...
<tiles:insertDefinition name=".form.buttons" >
	<tiles:putAttribute name="cancelAction"  value="cancelEditServiceGeneralProperties" />
	<tiles:putAttribute name="resetAction"  value="resetEditServiceGeneralProperties" />
</tiles:insertDefinition>
