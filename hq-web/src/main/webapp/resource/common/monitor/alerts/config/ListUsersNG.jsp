...
<display:table cellspacing="0" cellpadding="0" width="100%" action="${selfUrl}" pageSize="${pageSize}" items="${notifyList}">
  ...
  <display:column width="20%" property="name" sort="true" sortAttr="0" defaultSort="true" title="alert.config.props.NB.Username" href="viewUser.action?mode=view" paramId="u" paramProperty="id"/>
