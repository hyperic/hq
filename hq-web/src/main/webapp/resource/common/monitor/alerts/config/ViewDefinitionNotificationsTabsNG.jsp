...
<c:forEach var="tab" items="${tabList}">
  ...
  <c:choose>
    <c:when test="${mode == tab.link}">
      <td valign="top" width="15"><img src='<s:url value="/images/miniTabs_left_on.gif"/>' width="11" height="19" alt="" border="0"/></td>
      <td class="MiniTabOn" nowrap><fmt:message key="monitoring.events.MiniTabs.${tab.value}"/></td>
      <td valign="top" width="17"><img src='<s:url value="/images/miniTabs_right_on.gif"/>' width="11" height="19" alt="" border="0"/></td>
    </c:when>
    ...
    <c:otherwise>
      <td valign="top" width="15"><img src='<s:url value="/images/miniTabs_left_off.gif"/>' width="11" height="19" alt="" border="0"/></td>
      <td class="MiniTabOff" nowrap>
        <s:a href="%{#attr.tabUrl}"><fmt:message key="monitoring.events.MiniTabs.${tab.value}"/></s:a></td>
      <td valign="top" width="17"><img src='<s:url value="/images/miniTabs_right_off.gif"/>' width="11" height="19" alt="" border="0"/></td>
    </c:otherwise>
  </c:choose>
</c:forEach>
        </tr>
