      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
          <td class="MonitorChartCell"
            rowspan="2"><img src='<s:url value="/images/spacer.gif"/>' width="1"
        ...
        <tr>
          <td class="MonitorChartCell">
            <tiles:insertDefinition name=".resource.common.monitor.visibility.charts.metric.chartlegend"/>
          </td>
        </tr>
        <tr>
          <td class="MonitorChartBlock" colspan="3">
            <tiles:insertTemplate template="/resource/common/monitor/visibility/ChartTimeIntervalToolbarNG.jsp">
              <tiles:putAttribute name="form" value="${ViewChartForm}"/>
              <tiles:putAttribute name="formName" value="ViewChartForm"/>
              <tiles:putAttribute name="rangeNow" value="${ViewChartForm.rangeNow}"/>
              <tiles:putAttribute name="begin" value="${metricRange.begin}"/>
              <tiles:putAttribute name="end" value="${metricRange.end}"/>
