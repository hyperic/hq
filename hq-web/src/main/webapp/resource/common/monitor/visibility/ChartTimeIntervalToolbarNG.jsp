...
<table width="100%" cellpadding="0" cellspacing="0" border="0" id="advancedTbl">
  <tr>
    <td class="BlockBottomLine" colspan="3"><img
      src='<s:url value="/images/spacer.gif"/>' width="1" height="1" border="0"/></td>
  </tr>
  <tr>
    <td class="BlockContent" width="100%" align="right">
      <input type="image" name="${prevProperty}" src='<s:url value="/images/tbb_pageleft.gif"/>' border="0"/>
    </td>
    ...
    <td class="BlockContent">
      ...
      <img src='<s:url value="/images/tbb_pageright_gray.gif"/>' border="0"/>
      </c:when>
      <c:otherwise>
      <input type="image" name="${nextProperty}" src='<s:url value="/images/tbb_pageright.gif"/>' border="0"/>
      </c:otherwise>
      </c:choose>
    </td>
  </tr>
    ...
    <td class="BlockContent" colspan="3" id="advancedContainer">
      <div id="advancedDisplay" class="dialog" style="display: none;">
        ...
        <tiles:insertDefinition name=".resource.common.monitor.visibility.embeddedMetricDisplayRange">
          ...
          <tiles:putAttribute name="metricsForm" value="${form}"/>
