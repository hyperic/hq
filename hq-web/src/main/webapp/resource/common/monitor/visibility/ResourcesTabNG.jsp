...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="DashTabs">
  <tr>
    <td class="MiniTabEmpty" width="20"><img src='<s:url value="/images/spacer.gif"/>' width="20" height="1" alt="" border="0"/></td>

    <td valign="top" width="104"><img src='<s:url value="/images/MiniTab_Resources_on.gif"/>' height="15" alt="Resources" border="0"/></td>
