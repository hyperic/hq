...
<c:set var="tmpImg"><img src='<s:url value="/images/icon_alert.gif"/>' width="11" height="11" alt="" border="0"/></c:set>
...
<c:set var="listSize" value="${fn:length(summaries)}" />
<tiles:insertDefinition name=".resource.common.monitor.visibility.metricsToolbar">
  <tiles:putAttribute name="widgetInstanceName" value="${chbtWidget}"/>
  <tiles:putAttribute name="useCompareButton" value="true"/>
  <tiles:putAttribute name="usePager" value="true"/>
  <tiles:putAttribute name="listItems" value="${summaries}"/>
