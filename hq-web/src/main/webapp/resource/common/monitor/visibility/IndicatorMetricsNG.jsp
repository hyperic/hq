	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0"
		...
		<tr>
			...
			<tiles:insertTemplate template="/common/components/ActionButtonNG.jsp">
			  <tiles:putAttribute name="labelKey" value="common.label.ViewMetrics"/>
			  <tiles:putAttribute name="buttonClick" value="document.ProblemMetricsDisplayForm.submit(); return false;"/>
			</tiles:insertTemplate> <s:hidden theme="simple" name="fresh" value="false" /> <%--<input type="image" src='<s:url value="/images/fb_addResourcesApply.gif"/>' border="0" onmouseover="imageSwap(this, imagePath + 'fb_addResourcesApply', '_over');" onmouseout="imageSwap(this, imagePath +  'fb_addResourcesApply', '');" onmousedown="imageSwap(this, imagePath +  'fb_addResourcesApply', '_down')"/>
    <s:hidden theme="simple" name="fresh" value="false"/>--%></td>
			<td style="padding-left: 5px; padding-right: 3px">
			<img
				src='<s:url value="/images/icon_info2.gif"/>'
	...
	<c:when test="${not empty problems}">
		...
		<c:forEach var="metric" items="${problems}" varStatus="status">
			...
			<ul>
				...
				<li><s:a href=""
					onclick="window.open('%{#attr.metadataLink}','_metricMetadata','width=800,height=%{#attr.metadataPopupHeight},scrollbars=yes,toolbar=no,left=80,top=80,resizable=yes'); return false;">
					<fmt:message
