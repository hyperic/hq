...
<c:choose>
  ...
  <c:when test="${MetricSummaries[0].measurementTemplate.collectionType == staticConst}">
...
<tiles:insertDefinition name=".page.title.resource.generic">
  <tiles:putAttribute name="titleKey" value="resource.common.monitor.visibility.MetricMetadata"/>
  <tiles:putAttribute name="titleName" value="${resourceName}" />
