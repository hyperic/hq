...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
 ...
 <c:if test="${not hideLogs}">
   <tiles:insertTemplate template="/resource/common/monitor/visibility/EventLogsNG.jsp"/>
 </c:if>
 <tr>
     <td width="10">
         <div id="timetop"></div>
         <img src='<s:url value="/images/timeline_ll.gif"/>' height="10"/>
     </td>
     ...
     <td width="100%">
         ...
         <img src='<s:url value="/images/timeline_lr.gif"/>' height="10"/>
     </td>
     <c:if test="${isPlatform}">
     ...
     <table cellspacing="0" width="100%">
       <tr>
         ...
         <td valign="top" style="text-align: right; border-bottom: solid; border-width: 1px; border-color: #000000;">
           <img src='<s:url value="/images/dash-icon_delete.gif"/>'
