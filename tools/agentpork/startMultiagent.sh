...
echo "==== STARTING AND POPULATING MBEAN SERVER ===="

# Start MBean Server and add mbeans
cd agent_builds/mbeanserver
./startAll.sh $HOSTNAME 5 150 10
cd ../..
...
if [ ! -d hqapi1-3.1 ]
then
  wget http://10.0.0.240/raid/release/candidates/qatools/hqapi1-3.1.tar.gz
