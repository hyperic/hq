...
public @interface OperationEndpoint {
    ...
    String request() default Routing.EXCHANGE_REQUEST;

    String response() default Routing.EXCHANGE_RESPONSE;

    String requestBinding() default "";

    String responseBinding() default "";
