...
public class SimpleRabbitTemplate implements RabbitTemplate {
    ...
    private volatile Class<?> convertTo;
    ...
    public SimpleRabbitTemplate(ConnectionFactory connectionFactory, Converter<Object, String> converter, Class<?> convertTo) {
        this.channelTemplate = new ChannelTemplate(connectionFactory);
        this.channel = channelTemplate.createChannel();
        this.converter = converter;
    ...
    /**
     * Synchronous publish to receive a response (necessary for hyperic - how
     * it is currently and primarily coded)
     ...
     */
    public Object publishAndReceive(String responseQueue, String exchange, String routingKey, Object data, Class<?> convertResponseTo, AMQP.BasicProperties props) throws ChannelException {
        this.convertTo = convertResponseTo;
