 ...
 */
public class AnonymousQueueFactoryBean extends AmqpFactoryBean implements FactoryBean<String> {
    ...
    public String getObject() throws ChannelException {
        return declarativeBindingHandler.bindExchangeToAnonymousQueue(AnonymousQueueFactoryBean.this.exchangeName,
