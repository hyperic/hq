...
public class RabbitAdminTemplate {
    ...
    public RabbitAdminTemplate(String node) {
        this();
        this.erlangTemplate = new RabbitErlangTemplate(node);
    }

    @SuppressWarnings("unchecked")
    public Node getNodeStatus() {
        return (Node) erlangTemplate.executeAndConvertRpc(getControlAction(RabbitErlangConverter.NodeStatus.class));
    }
    ...
    public List<String> getVirtualHosts() {
        return (List<String>) erlangTemplate.executeAndConvertRpc(getControlAction(RabbitErlangConverter.ListVirtualHosts.class));
    }
    ...
    public List<Exchange> getExchanges(String virtualHost) {
        return (List<Exchange>) erlangTemplate.executeAndConvertRpc(getControlAction(RabbitErlangConverter.ListExchanges.class), getBytes(virtualHost));
    }
    ...
    public List<Queue> getQueues(String virtualHost) {
        return (List<Queue>) erlangTemplate.executeAndConvertRpc(getControlAction(RabbitErlangConverter.ListQueues.class), getBytes(virtualHost));
    }

    public void addUser(String username, String password) {
        erlangTemplate.executeAndConvertRpc(getControlAction(RabbitErlangConverter.AddUser.class), getBytes(username), getBytes(password));
    }

    public void deleteUser(String username) {
        erlangTemplate.executeAndConvertRpc(getControlAction(RabbitErlangConverter.DeleteUser.class), getBytes(username));
    }

    public void changeUserPassword(String username, String newPassword) {
        erlangTemplate.executeAndConvertRpc(getControlAction(RabbitErlangConverter.ChangePassword.class), getBytes(username), getBytes(newPassword));
    }

    @SuppressWarnings("unchecked")
    public List<String> listUsers() {
        return (List<String>) erlangTemplate.executeAndConvertRpc(getControlAction(RabbitErlangConverter.ListUsers.class));
    }

    public BrokerStatus getBrokerStatus() {
        try {
            return (BrokerStatus) erlangTemplate.executeAndConvertRpc(getControlAction(RabbitErlangConverter.ListStatus.class));
    ...
    public String getVersion() {
        return (String) erlangTemplate.executeAndConvertRpc(RabbitErlangConverter.BrokerVersion.create());
    }
