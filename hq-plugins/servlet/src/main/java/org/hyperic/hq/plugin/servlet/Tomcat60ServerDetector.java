...
public class Tomcat60ServerDetector 
    extends Tomcat55ServerDetector
    implements FileServerDetector,
               RegistryServerDetector {

    static final String UNIQUE_JAR = "STANDALONE-DISCOVER-NOTSUPPORTED.XXX";

    private Log log = LogFactory.getLog("Tomcat60ServerDetector");

    public Tomcat60ServerDetector () { 
        super();
