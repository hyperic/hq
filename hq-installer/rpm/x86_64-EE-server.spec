...
Source0:        %{HQ_Component_Name}-%{HQ_Component_Version}-%{HQ_Component_Edition}-%{HQ_Component_Build}.tgz
Vendor:		Hyperic, Inc.
License:        Commercial
...
%{__rm} -f installer-%{HQ_Component_Version}-EE/lib/sigar-x86-winnt.lib
...
#%{__cp} %{prefix}/%{name}/installer-3.2.0-EE/hq-install.log %{prefix}/server-%{version}-%{HQ_Component_Edition}/
%{__rm} -Rf %{prefix}/%{name}
...
* Thu Apr 17 2008 Hyperic Support <support@hyperic.com> 3.2.3-EE-x86_64-linux-1
* Tue Mar 25 2008 Hyperic Support <support@hyperic.com> 3.2.2-EE-x86_64-linux-1
* Thu Feb 28 2008 Hyperic Support <support@hyperic.com> 3.2.1-EE-x86_64-linux-1
* Wed Jan 29 2008 Hyperic Support <support@hyperic.com> 3.2.0-EE-x86_64-linux-1
- Initial release.
