...
CLIENT_CLASSPATH="${CLIENT_CLASSPATH}:${AGENT_LIB}/hq-operation-service-rabbit-annotation-${project.version}.jar"
CLIENT_CLASSPATH="${CLIENT_CLASSPATH}:${AGENT_LIB}/hq-operation-service-rabbit-util-${project.version}.jar"
