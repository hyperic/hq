...
:haveBuiltinJRE:
if exist "%INSTALL_DIR%\jres\x86-win32-1.7_40.exe" ( 
	SET EXE=x86-win32-1.7_40.exe
)else ( 
 	if exist "%INSTALL_DIR%\jres\x86_64-win-1.7_40.exe" ( 
 		SET EXE=x86_64-win-1.7_40.exe
 	) 
 )
